...
from v28_successor_live_surface import (
    DEFAULT_CANDIDATE_ID as DEFAULT_V28_SUCCESSOR_CANDIDATE_ID,
    DEFAULT_MODEL_HASH as DEFAULT_V28_SUCCESSOR_MODEL_HASH,
    V28SuccessorSurface,
    load_surface as load_v28_successor_surface,
)
...
V28_SUCCESSOR_DEFAULT_MANIFEST_PATH = SCRIPT_DIR / "research_particle" / "v28_successor" / "candidate_manifests_logged_events_latest.json"
...
class Config:
    ...
    live_entry_fast_fill_min_depth_ratio: float = 0.0
    ...
    mushroom_v28_btc_ws_stale_reconnect_ms: float = 0.0
    mushroom_v28_btc_rest_fallback_enabled: bool = False
    mushroom_v28_btc_rest_fallback_url: str = "https://api.coinbase.com/v2/prices/BTC-USD/spot"
    mushroom_v28_btc_rest_fallback_min_interval_ms: float = 1000.0
    mushroom_v28_feature_gate_enabled: bool = False
    mushroom_v28_feature_gate_raw_edge_prob_min: float = 0.05
    mushroom_v28_feature_gate_recross_max: float = 0.60
    mushroom_v28_feature_gate_abs_d_min: float = 0.85
    mushroom_v28_feature_gate_abs_d_max: float = 0.0
    mushroom_v28_feature_gate_ask_prob_min: float = 0.0
    mushroom_v28_successor_surface_enabled: bool = False
    mushroom_v28_successor_manifest_path: Path = V28_SUCCESSOR_DEFAULT_MANIFEST_PATH
    mushroom_v28_successor_candidate_id: str = DEFAULT_V28_SUCCESSOR_CANDIDATE_ID
    mushroom_v28_successor_model_hash: str = DEFAULT_V28_SUCCESSOR_MODEL_HASH
    mushroom_v28_successor_entry_mode: str = "overlay_probability"
    mushroom_v28_successor_shadow_min_edge_cents: float = 1.0
    ...
    mushroom_v28_exit_guard_mode: str = "disabled"
    mushroom_v28_exit_guard_ledger_path: Path = SCRIPT_DIR / "logs" / "mushroom_v28_exit_guard_shadow.ndjson"
    mushroom_v28_exit_guard_kill_switch: bool = False
    mushroom_v28_exit_guard_kill_state_path: Path = SCRIPT_DIR / "state" / "mushroom_v28_exit_guard_kill_state.json"
    mushroom_v28_exit_guard_max_loss_cluster: int = 3
    mushroom_v28_exit_guard_max_drawdown_cents: int = 200
    mushroom_v28_exit_guard_reconciliation_enabled: bool = False
    mushroom_v28_exit_guard_reconciliation_path: Path = SCRIPT_DIR / "logs" / "exchange_reconciliation.ndjson"
    mushroom_v28_exit_guard_reconciliation_max_fills: int = 100
    mushroom_v28_phi_memory_enabled: bool = False
    mushroom_v28_phi_memory_mode: str = "shadow"
    mushroom_v28_phi_memory_state_path: Path = SCRIPT_DIR / "state" / "mushroom_v28_phi_reward_memory_state.json"
    mushroom_v28_phi_memory_log_path: Path = SCRIPT_DIR / "logs" / "v28_phi_reward_memory.ndjson"
    mushroom_v28_phi_memory_entry_cap_cents: float = 1.0
    mushroom_v28_phi_memory_exit_cap_cents: float = 2.0
    mushroom_v28_phi_memory_allow_add_entries: bool = True
    mushroom_v28_phi_memory_allow_size_increase: bool = True
    mushroom_v28_phi_memory_allow_side_flip_live: bool = False
    mushroom_v28_phi_memory_kill_switch: bool = False
    mushroom_v28_phi_memory_kill_net_pnl_dollars: float = -4.0
    mushroom_v28_phi_memory_kill_loss_cluster: int = 6
    mushroom_v28_phi_memory_near_edge_min_cents: float = 2.0
    mushroom_v28_phi_memory_near_depth_ratio_min: float = 6.0
    mushroom_v28_phi_memory_required_depth_ratio: float = 8.0
    mushroom_v28_phi_memory_near_abs_d_min: float = 0.75
    mushroom_v28_phi_memory_near_abs_d_max: float = 1.15
    mushroom_v28_phi_memory_rich_exit_recheck_bid_cents: int = 80
    mushroom_v28_phi_memory_rich_exit_recheck_seconds: float = 5.0
    mushroom_v28_phi_memory_report_interval_seconds: float = 900.0
    mushroom_v28_adaptive_exit_enabled: bool = False
    mushroom_v28_adaptive_exit_mode: str = "shadow"
    mushroom_v28_adaptive_exit_state_path: Path = SCRIPT_DIR / "state" / "v28_adaptive_exit_supervisor_state.json"
    mushroom_v28_adaptive_exit_log_path: Path = SCRIPT_DIR / "logs" / "v28_adaptive_exit_supervisor.ndjson"
    mushroom_v28_adaptive_exit_cheap_no_entry_max_cents: float = 15.0
    mushroom_v28_adaptive_exit_reduce_fraction: float = 0.5
    mushroom_v28_adaptive_exit_recheck_seconds: float = 5.0
    mushroom_v28_adaptive_exit_panic_p_hold_floor: float = 0.03
    mushroom_v28_adaptive_exit_disable_min_observations: int = 3
    mushroom_v28_adaptive_exit_disable_delta_cents: float = -150.0
    mushroom_v28_adaptive_exit_restore_min_observations: int = 5
    mushroom_v28_adaptive_exit_restore_delta_cents: float = 150.0
    mushroom_v28_lifecycle_enabled: bool = False
    mushroom_v28_lifecycle_mode: str = "shadow"
    mushroom_v28_lifecycle_state_path: Path = SCRIPT_DIR / "state" / "v28_trade_lifecycle_state.json"
    mushroom_v28_lifecycle_log_path: Path = SCRIPT_DIR / "logs" / "v28_trade_lifecycle.ndjson"
    mushroom_v28_lifecycle_exit_toll_cents: float = 2.5
    mushroom_v28_lifecycle_recheck_seconds: float = 5.0
    mushroom_v28_lifecycle_cheap_entry_max_cents: float = 15.0
    mushroom_v28_lifecycle_promote_delta_cents: float = 100.0
    mushroom_v28_lifecycle_disable_bad_settles: int = 3
    mushroom_v28_lifecycle_min_promote_observations: int = 5
    mushroom_v28_reject_telemetry_enabled: bool = False
    mushroom_v28_reject_telemetry_interval_seconds: float = 20.0
...
class PositionState:
    ...
    entry_fill_price_cents: int | float | None = None
    entry_fee_cents: int | float = 0
    entry_trigger_price_cents: int | None = None
    lifecycle_bucket: str = ""
    lifecycle_reason: str = ""
    lifecycle_classified_at: str = ""
...
class SubmissionResult:
    ...
    client_order_id: str
    status: str
    fill_count: int | float
    remaining_count: int | float
    submit_latency_ms: float
    limit_price_cents: int
    time_in_force: str
    actual_fill_price_cents: int | float | None = None
    actual_fee_cents: int | float | None = None
    error_text: str = ""
...
class ExecutionTelemetryContext:
    ...
    exchange_status: str = ""
    fill_count: int | float | None = None
    remaining_count: int | float | None = None
    actual_fill_price_cents: int | float | None = None
    actual_fee_cents: int | float | None = None
    result: str = ""
    executable_window_ms: float | None = None
...
class KalshiClient:
    ...
    def get_fills(self, ticker: str | None = None, limit: int = 100) -> list[dict[str, Any]]:
        params: dict[str, Any] = {"subaccount": 0, "limit": max(1, int(limit))}
        if ticker:
            params["ticker"] = ticker
        data = self.request("GET", "/portfolio/fills", params=params, auth=True)
        return list(data.get("fills", data.get("portfolio_fills", [])))
...
class BTC15MKalshiWebSocketBot:
    def __init__(self, config: Config) -> None:
        ...
        self.mushroom_v28_successor_surface = self.build_mushroom_v28_successor_surface()
        self.mushroom_v28_phi_memory = self.build_mushroom_v28_phi_memory()
        self.mushroom_v28_phi_memory_exit_rechecks: dict[str, float] = {}
        self.mushroom_v28_adaptive_exit_supervisor = self.build_mushroom_v28_adaptive_exit_supervisor()
        self.mushroom_v28_lifecycle = self.build_mushroom_v28_lifecycle()
        self.mushroom_v28_last_tick_monotonic = 0.0
        self.mushroom_v28_last_stale_reconnect_monotonic = 0.0
        self.mushroom_v28_last_rest_fallback_monotonic = 0.0
        self.mushroom_v28_btc_ws_endpoint_offset = 0
        ...
        self.mushroom_v28_reject_telemetry_last_emit: dict[str, float] = {}
    ...
    def entry_block_reason(self, ticker: str, side: str | None = None, count: int | None = None) -> str | None:
        ...
        add_count = max(Decimal("1"), quantity_to_decimal(count or self.config.position_size))
        if position is None:
        ...
        if quantity_to_decimal(position.count) + add_count > Decimal(str(max_contracts)):
    ...
    def weighted_average_cents(self, old_price: int | float | None, old_count: Any, new_price: int | float | None, new_count: Any) -> int | None:
        if old_price is None and new_price is None:
            return None
        old_qty = quantity_to_decimal(old_count)
        new_qty = quantity_to_decimal(new_count)
        if old_qty <= QUANTITY_EPSILON:
            return int(new_price) if new_price is not None else None
        if new_qty <= QUANTITY_EPSILON:
        ...
        total_count = old_qty + new_qty
        weighted = ((old_value * old_qty) + (new_value * new_qty)) / total_count
    ...
    def apply_entry_fill_to_position(
        ...
        *,
        ...
        entry_order_id: str,
        entry_limit_price_cents: int,
        entry_fill_price_cents: int | float,
        entry_fee_cents: int | float,
        entry_trigger_price_cents: int | None,
        entry_context: dict[str, Any] | None = None,
    ) -> PositionState:
        fill_qty = quantity_to_decimal(fill_count)
        if fill_qty <= QUANTITY_EPSILON:
        ...
        if existing is not None:
            ...
            old_count = quantity_to_decimal(existing.count)
            ...
            existing.count = quantity_to_number(old_count + fill_qty)
            ...
            existing.entry_fee_cents = round(float(existing.entry_fee_cents or 0.0) + float(entry_fee_cents or 0.0), 4)
            ...
            if self.mushroom_v28_lifecycle is not None:
                lifecycle = self.mushroom_v28_lifecycle.classify_entry_fill(
                    market_ticker=market_ticker,
                    side=side,
                    count=float(quantity_to_decimal(existing.count)),
                    entry_price_cents=float(existing.entry_fill_price_cents or existing.entry_limit_price_cents),
                    entry_fee_cents=float(existing.entry_fee_cents or 0.0),
                    fields=entry_context,
                )
                existing.lifecycle_bucket = str(lifecycle.get("bucket") or "")
                existing.lifecycle_reason = str(lifecycle.get("reason") or "")
                existing.lifecycle_classified_at = str(lifecycle.get("classified_at") or "")
            self.state.exit_confirmation = None
            return existing
        self.state.position = PositionState(
            market_ticker=market_ticker,
            side=side,
            count=quantity_to_number(fill_qty),
            filled_at=now_iso,
            entry_order_id=entry_order_id,
            entry_limit_price_cents=int(entry_limit_price_cents),
            entry_fill_price_cents=int(entry_fill_price_cents),
            entry_fee_cents=round(float(entry_fee_cents or 0.0), 4),
        ...
        if self.mushroom_v28_lifecycle is not None:
            lifecycle = self.mushroom_v28_lifecycle.classify_entry_fill(
                market_ticker=market_ticker,
                side=side,
                count=float(fill_qty),
                entry_price_cents=float(entry_fill_price_cents),
                entry_fee_cents=float(entry_fee_cents or 0.0),
                fields=entry_context,
            )
            self.state.position.lifecycle_bucket = str(lifecycle.get("bucket") or "")
            self.state.position.lifecycle_reason = str(lifecycle.get("reason") or "")
            self.state.position.lifecycle_classified_at = str(lifecycle.get("classified_at") or "")
        self.state.exit_confirmation = None
    ...
    def backfill_persisted_position_outcome(self) -> None:
        ...
        fee_cents = float(position.entry_fee_cents or 0.0)
        if fee_cents <= 0:
            fee_cents = self.estimated_order_fee_cents(fill_price_cents, max(1, math.ceil(float(position.count))))
        self.market_outcomes.record_entry(
            position.market_ticker,
            side=position.side,
            qty=float(position.count),
    ...
    def record_entry_fill_for_outcomes(
        ...
        *,
        ...
        side: str,
        fill_count: int | float,
        fill_price_cents: int | float,
        trigger_price_cents: int | None,
        actual_fee_cents: int | float | None,
    ) -> None:
        fill_qty = quantity_to_decimal(fill_count)
        if fill_qty <= QUANTITY_EPSILON or fill_price_cents <= 0:
            return
        effective_fee_cents = (
            float(actual_fee_cents)
            if actual_fee_cents is not None and float(actual_fee_cents) >= 0
            else self.estimated_order_fee_cents(int(round(float(fill_price_cents))), max(1, math.ceil(float(fill_qty))))
        )
        self.market_outcomes.record_entry(
            market_ticker,
            side=side,
    ...
    def record_exit_fill_for_outcomes(
        ...
        *,
        ...
        self.market_outcomes.record_exit_fill(
            ...
            fill_price_cents=fill_price_cents,
            fee_cents=effective_fee_cents,
            remaining_position=float(remaining_position),
            resolved_at=utc_now().isoformat(),
        )
        self.emit_post_entry_shadow_outcome_if_ready(market_ticker)

    def learn_mushroom_v28_phi_memory_settlement(self, market_ticker: str, result: str) -> None:
        record = self.market_outcomes.get(market_ticker)
        actual_pnl = float(record.pnl_dollars) if record is not None else None
        if self.mushroom_v28_adaptive_exit_supervisor is not None:
            adaptive_outcome = self.mushroom_v28_adaptive_exit_supervisor.learn_from_settlement(
                market=market_ticker,
                result=result,
            )
            if adaptive_outcome.get("updated"):
                self.logger.info(
                    "Mushroom v28 adaptive exit supervisor update | market=%s result=%s decisions=%s used=%s delta=%.2fc",
                    market_ticker,
                    result,
                    adaptive_outcome.get("decision_count"),
                    adaptive_outcome.get("used_decision_count"),
                    float(adaptive_outcome.get("delta_cents") or 0.0),
                )
        if self.mushroom_v28_lifecycle is not None:
            lifecycle_outcome = self.mushroom_v28_lifecycle.learn_from_settlement(
                market_ticker=market_ticker,
                result=result,
                actual_pnl_cents=(actual_pnl * 100.0) if actual_pnl is not None else None,
                outcome_record=asdict(record) if record is not None else None,
            )
            if lifecycle_outcome is not None:
                self.logger.info(
                    "Mushroom v28 lifecycle reward update | market=%s result=%s reward_delta=%.2fc entry=%.2fc exit=%.2fc addon=%.2fc fee_saved=%.2fc",
                    market_ticker,
                    result,
                    float(lifecycle_outcome.get("reward_delta_cents") or 0.0),
                    float(lifecycle_outcome.get("entry_quality_cents") or 0.0),
                    float(lifecycle_outcome.get("exit_quality_cents") or 0.0),
                    float(lifecycle_outcome.get("addon_impact_cents") or 0.0),
                    float(lifecycle_outcome.get("fee_saved_cents") or 0.0),
                )
        if self.mushroom_v28_phi_memory is None:
            return
        outcome = self.mushroom_v28_phi_memory.learn_from_settlement(
            market=market_ticker,
            result=result,
        ...
        if outcome.get("updated"):
            self.logger.info(
                "Mushroom v28 phi memory reward update | market=%s result=%s decisions=%s fills=%s labels=%s reward_delta=%.2fc actual_pnl=%s",
                market_ticker,
                result,
                outcome.get("used_decision_count"),
                outcome.get("actual_fill_decision_count"),
                outcome.get("unfilled_label_decision_count"),
                float(outcome.get("reward_delta_cents") or 0.0),
                outcome.get("actual_pnl_dollars"),
            )
            if self.mushroom_v28_phi_memory.state.get("downgraded"):
                self.logger.warning(
                    "Mushroom v28 phi memory downgraded to raw v28 | reason=%s",
                    self.mushroom_v28_phi_memory.state.get("downgrade_reason"),
                )
    ...
    async def maybe_finalize_market_outcome_from_exchange(self, market_ticker: str) -> None:
        ...
        if record is None:
            return
        phi_pending = (
            self.mushroom_v28_phi_memory is not None
            and self.mushroom_v28_phi_memory.has_pending_market(market_ticker)
        )
        lifecycle_pending = (
            self.mushroom_v28_lifecycle is not None
            and self.mushroom_v28_lifecycle.has_pending_market(market_ticker)
        )
        if record.outcome_type in {"exit", "win", "settlement_loss", "void", "no_trade"} and not phi_pending and not lifecycle_pending:
            return
        if not record.traded and (
            not phi_pending
            and not lifecycle_pending
        ):
        ...
        if result in {"yes", "no", "void"}:
            ...
            if not record.traded:
                self.market_outcomes.finalize_no_trade(market_ticker, resolved_at=resolved_at)
            self.learn_mushroom_v28_phi_memory_settlement(market_ticker, result)
            self.emit_post_entry_shadow_outcome_if_ready(market_ticker)
            return
    ...
    def mushroom_v28_phi_memory_pending_closed_outcomes(self, *, as_of: datetime | None = None, limit: int = 8) -> list[Any]:
        if self.mushroom_v28_phi_memory is None:
            return []
        pending = self.mushroom_v28_phi_memory.state.get("pending_markets", {})
        if not isinstance(pending, dict) or not pending:
            return []
        now = as_of or utc_now()
        records: list[Any] = []
        for market_ticker in list(pending.keys()):
            record = self.market_outcomes.get(str(market_ticker))
            if record is None:
                continue
    ...
    def mushroom_v28_lifecycle_pending_closed_outcomes(self, *, as_of: datetime | None = None, limit: int = 8) -> list[Any]:
        if self.mushroom_v28_lifecycle is None:
            return []
        pending = self.mushroom_v28_lifecycle.state.get("pending_decisions", {})
        if not isinstance(pending, dict) or not pending:
            return []
        now = as_of or utc_now()
        records: list[Any] = []
    ...
    async def refresh_recent_market_outcomes_from_exchange(self, limit: int = 8) -> None:
        ...
        records_by_market = {
            ...
            for record in self.market_outcomes.unresolved_closed_markets(as_of=now, limit=limit)
        }
        for record in self.mushroom_v28_phi_memory_pending_closed_outcomes(as_of=now, limit=limit):
            records_by_market.setdefault(record.market, record)
        for record in self.mushroom_v28_lifecycle_pending_closed_outcomes(as_of=now, limit=limit):
            records_by_market.setdefault(record.market, record)
        records = sorted(records_by_market.values(), key=lambda row: row.sort_key())
        ...
        try:
            ...
            while not self.shutdown_event.is_set():
                try:
                    ...
                    await self.ensure_mushroom_v28_btc_tick_task()
                    await self.maybe_restart_mushroom_v28_btc_tick_task_if_stale()
    ...
    async def bootstrap_safety_check(self) -> None:
        ...
        if not self.config.dry_run:
            try:
                ...
                self.logger.warning("Live account position check failed on startup. Blocking entries until account polling succeeds. Error: %s", exc)
            else:
                nonzero = nonzero_live_positions(live_positions)
                if self.state.position is not None:
                    ...
                    if not matching_live:
                        ...
                        await self.maybe_finalize_market_outcome_from_exchange(stale_ticker)
                if nonzero:
                    conflict_reason = live_account_position_conflict_reason(nonzero, self.state.position)
                    if conflict_reason:
                        tickers = ",".join(live_position_ticker(pos) or "UNKNOWN" for pos in nonzero)
                        message = (
                            "Live account position/local state mismatch on startup "
                            f"reason={conflict_reason} tickers={tickers}. "
                            "Blocking live bot until exchange exposure is reconciled."
                        )
                        self.logger.error(message)
                        raise RuntimeError(message)
                    self.logger.warning(
                        "Live account has %s nonzero position entries that match local state.",
                        len(nonzero),
                    )
    ...
    def mushroom_v28_configured(self) -> bool:
        return bool(
            ...
            or self.config.mushroom_v28_phi_memory_enabled
            or self.config.mushroom_v28_adaptive_exit_enabled
            or self.config.mushroom_v28_lifecycle_enabled
        )
    ...
    def build_mushroom_v28_successor_surface(self) -> V28SuccessorSurface | None:
        if not self.config.mushroom_v28_successor_surface_enabled:
            return None
        return load_v28_successor_surface(
            self.config.mushroom_v28_successor_manifest_path,
            candidate_id=str(self.config.mushroom_v28_successor_candidate_id),
            expected_model_hash=str(self.config.mushroom_v28_successor_model_hash),
        )

    def build_mushroom_v28_phi_memory(self) -> PhiRewardMemoryController | None:
        if not self.config.mushroom_v28_phi_memory_enabled:
            return None
        memory_config = PhiRewardMemoryConfig(
            enabled=True,
            mode=str(self.config.mushroom_v28_phi_memory_mode or "shadow").strip().lower(),
            max_entry_correction_cents=float(self.config.mushroom_v28_phi_memory_entry_cap_cents),
            max_exit_correction_cents=float(self.config.mushroom_v28_phi_memory_exit_cap_cents),
            allow_add_entries=bool(self.config.mushroom_v28_phi_memory_allow_add_entries),
            allow_size_increase=bool(self.config.mushroom_v28_phi_memory_allow_size_increase),
            allow_side_flip_live=bool(self.config.mushroom_v28_phi_memory_allow_side_flip_live),
            kill_switch=bool(self.config.mushroom_v28_phi_memory_kill_switch),
            kill_net_pnl_dollars=float(self.config.mushroom_v28_phi_memory_kill_net_pnl_dollars),
            kill_loss_cluster=int(self.config.mushroom_v28_phi_memory_kill_loss_cluster),
            report_interval_seconds=float(self.config.mushroom_v28_phi_memory_report_interval_seconds),
            near_edge_min_cents=float(self.config.mushroom_v28_phi_memory_near_edge_min_cents),
            near_depth_ratio_min=float(self.config.mushroom_v28_phi_memory_near_depth_ratio_min),
            required_depth_ratio=float(self.config.mushroom_v28_phi_memory_required_depth_ratio),
            near_abs_d_min=float(self.config.mushroom_v28_phi_memory_near_abs_d_min),
            near_abs_d_max=float(self.config.mushroom_v28_phi_memory_near_abs_d_max),
            rich_exit_recheck_bid_cents=int(self.config.mushroom_v28_phi_memory_rich_exit_recheck_bid_cents),
            rich_exit_recheck_seconds=float(self.config.mushroom_v28_phi_memory_rich_exit_recheck_seconds),
        )
        return PhiRewardMemoryController(
            config=memory_config,
            state_path=self.config.mushroom_v28_phi_memory_state_path,
            log_path=self.config.mushroom_v28_phi_memory_log_path,
        )

    def build_mushroom_v28_adaptive_exit_supervisor(self) -> AdaptiveExitSupervisor | None:
        if not self.config.mushroom_v28_adaptive_exit_enabled:
            return None
        supervisor_config = AdaptiveExitSupervisorConfig(
            enabled=True,
            mode=str(self.config.mushroom_v28_adaptive_exit_mode or "shadow").strip().lower(),
            cheap_no_entry_max_cents=float(self.config.mushroom_v28_adaptive_exit_cheap_no_entry_max_cents),
            reduce_fraction=float(self.config.mushroom_v28_adaptive_exit_reduce_fraction),
            recheck_seconds=float(self.config.mushroom_v28_adaptive_exit_recheck_seconds),
            panic_p_hold_floor=float(self.config.mushroom_v28_adaptive_exit_panic_p_hold_floor),
            disable_min_observations=int(self.config.mushroom_v28_adaptive_exit_disable_min_observations),
            disable_delta_cents=float(self.config.mushroom_v28_adaptive_exit_disable_delta_cents),
            restore_min_observations=int(self.config.mushroom_v28_adaptive_exit_restore_min_observations),
            restore_delta_cents=float(self.config.mushroom_v28_adaptive_exit_restore_delta_cents),
        )
        return AdaptiveExitSupervisor(
            config=supervisor_config,
            state_path=self.config.mushroom_v28_adaptive_exit_state_path,
            log_path=self.config.mushroom_v28_adaptive_exit_log_path,
        )

    def build_mushroom_v28_lifecycle(self) -> TradeLifecycleController | None:
        if not self.config.mushroom_v28_lifecycle_enabled:
            return None
        lifecycle_config = TradeLifecycleConfig(
            enabled=True,
            mode=str(self.config.mushroom_v28_lifecycle_mode or "shadow").strip().lower(),
            state_path=self.config.mushroom_v28_lifecycle_state_path,
            log_path=self.config.mushroom_v28_lifecycle_log_path,
            exit_toll_cents=float(self.config.mushroom_v28_lifecycle_exit_toll_cents),
            recheck_seconds=float(self.config.mushroom_v28_lifecycle_recheck_seconds),
            cheap_entry_max_cents=float(self.config.mushroom_v28_lifecycle_cheap_entry_max_cents),
            promote_delta_cents=float(self.config.mushroom_v28_lifecycle_promote_delta_cents),
            disable_bad_settles=int(self.config.mushroom_v28_lifecycle_disable_bad_settles),
            min_promote_observations=int(self.config.mushroom_v28_lifecycle_min_promote_observations),
        )
        return TradeLifecycleController(lifecycle_config)

    def mushroom_v28_phi_trend_context(self) -> dict[str, float]:
        if self.mushroom_v28_worker is None:
            return {"5m": 0.0, "15m": 0.0, "1h": 0.0, "3h": 0.0, "1d": 0.0, "phi": 0.0}
        with self.mushroom_lock:
            return compute_trend_context_from_engine(self.mushroom_v28_worker.engine)
    ...
    async def maybe_restart_mushroom_v28_btc_tick_task_if_stale(self) -> None:
        threshold_ms = float(self.config.mushroom_v28_btc_ws_stale_reconnect_ms)
        if (
            threshold_ms <= 0
            or self.mushroom_v28_worker is None
            or not self.config.mushroom_v28_btc_ws_enabled
            or not self.mushroom_v28_configured()
            or self.mushroom_v28_btc_tick_task is None
            or self.mushroom_v28_btc_tick_task.done()
        ):
            return
        age_ms = self.mushroom_v28_btc_age_ms()
        if age_ms is None or float(age_ms) <= threshold_ms:
            return
        now_mono = time.monotonic()
        cooldown_seconds = max(
            threshold_ms / 1000.0,
            float(self.config.websocket_reconnect_seconds),
            1.0,
        )
        if (
            self.mushroom_v28_last_stale_reconnect_monotonic > 0
            and now_mono - self.mushroom_v28_last_stale_reconnect_monotonic < cooldown_seconds
        ):
            return
        if bool(self.config.mushroom_v28_btc_rest_fallback_enabled):
            min_rest_gap = max(0.1, float(self.config.mushroom_v28_btc_rest_fallback_min_interval_ms) / 1000.0)
            if now_mono - self.mushroom_v28_last_rest_fallback_monotonic >= min_rest_gap:
                self.mushroom_v28_last_rest_fallback_monotonic = now_mono
                if await asyncio.to_thread(self.refresh_mushroom_v28_btc_rest_tick):
                    self.logger.info(
                        "Mushroom v28 BTC REST fallback refreshed stale tick | previous_age_ms=%.1f threshold_ms=%.1f source=%s",
                        float(age_ms),
                        threshold_ms,
                        self.mushroom_v28_last_tick_source or "unknown",
                    )
                    return
                self.logger.warning(
                    "Mushroom v28 BTC REST fallback failed | previous_age_ms=%.1f threshold_ms=%.1f error=%s",
                    float(age_ms),
                    threshold_ms,
                    self.mushroom_v28_last_error or "unknown",
                )
        endpoints = self.mushroom_v28_btc_ws_endpoints()
        if len(endpoints) > 1:
            self.mushroom_v28_btc_ws_endpoint_offset = (
                int(self.mushroom_v28_btc_ws_endpoint_offset) + 1
            ) % len(endpoints)
        next_url = endpoints[int(self.mushroom_v28_btc_ws_endpoint_offset) % len(endpoints)] if endpoints else ""
        self.mushroom_v28_last_stale_reconnect_monotonic = now_mono
        self.logger.warning(
            "Mushroom v28 BTC tick stream stale. Restarting | age_ms=%.1f threshold_ms=%.1f source=%s next_source=%s next_url=%s",
            float(age_ms),
            threshold_ms,
            self.mushroom_v28_last_tick_source or "unknown",
            self.mushroom_v28_btc_ws_source(next_url) if next_url else "unknown",
            next_url,
        )
        await self.stop_mushroom_v28_btc_tick_task()
        await self.ensure_mushroom_v28_btc_tick_task()

    def mushroom_v28_btc_ws_endpoints(self) -> list[str]:
        endpoints = [
    ...
    async def mushroom_v28_btc_tick_loop(self) -> None:
        ...
        endpoint_index = int(self.mushroom_v28_btc_ws_endpoint_offset)
        while not self.shutdown_event.is_set():
            ...
            try:
                ...
                endpoint_index += 1
                self.mushroom_v28_btc_ws_endpoint_offset = endpoint_index % len(endpoints)
    ...
    def refresh_mushroom_v28_btc_rest_tick(self) -> bool:
        url = str(self.config.mushroom_v28_btc_rest_fallback_url or "").strip()
        if not url:
            return False
        try:
            resp = requests.get(
                url,
                timeout=min(5.0, max(1.0, float(self.config.http_timeout_seconds))),
                headers={"User-Agent": "kalshi-btc15m-v28"},
            )
            ...
            if not isinstance(payload, dict):
                return False
            price_raw = payload.get("amount") or payload.get("price") or payload.get("last") or payload.get("last_price")
            price = float(price_raw)
        except Exception as exc:  # noqa: BLE001
            self.mushroom_v28_last_error = f"btc_rest_fallback:{exc}"
            return False
        source = "coinbase_spot_rest" if "coinbase" in url.lower() else "btc_rest_fallback"
        self.update_mushroom_v28_btc_tick(price, ts=utc_now(), volume=0.0, source=source)
        return True
    ...
    async def maybe_check_pending_order(self) -> None:
        ...
        if self.config.dry_run:
            ...
            if pending.purpose == "entry":
                ...
                if self.state.position is not None:
                    remaining_position = quantity_to_number(
                        max(
                            Decimal("0"),
                            quantity_to_decimal(self.state.position.count) - quantity_to_decimal(pending.count),
                        )
                    )
        ...
        remaining_count = quantity_to_number(parse_order_count_decimal(order, purpose="remaining"))
        ...
        if (
            not quantity_positive(fill_count)
            and pending.order_id
            and status in {"canceled", "cancelled", "executed", "filled"}
        ):
            fill_summary = await self.reconcile_recent_fills_for_order(
                market_ticker=pending.market_ticker,
            ...
            if fill_summary is not None:
                ...
                remaining_count = fill_summary["remaining_count"]
                actual_fill_price_cents = fill_summary["actual_fill_price_cents"]
                actual_fee_cents = fill_summary["actual_fee_cents"]
                self.logger.warning(
                    "Recovered exchange fill during pending-order check | market=%s side=%s order_id=%s qty=%s fill=%sc fee=%sc fill_ids=%s",
                    pending.market_ticker,
                    pending.side,
                    pending.order_id,
                    format_quantity(fill_count),
                    actual_fill_price_cents,
                    actual_fee_cents,
                    ",".join(fill_summary.get("fill_ids", [])),
                )
        self.logger.info(
        ...
        if quantity_positive(fill_count) and (
            quantity_to_decimal(fill_count) + QUANTITY_EPSILON >= quantity_to_decimal(pending.count)
            or status in {"executed", "filled", "canceled", "cancelled"}
        ):
            if pending.purpose == "entry":
                entry_fill_cents = actual_fill_price_cents or pending.limit_price_cents
                entry_fee_cents = actual_fee_cents if actual_fee_cents is not None else self.estimated_order_fee_cents(int(round(float(entry_fill_cents))), max(1, math.ceil(float(quantity_to_decimal(fill_count)))))
                self.record_entry_fill_for_outcomes(
                    market_ticker=pending.market_ticker,
                    side=pending.side,
                ...
                remaining_position = quantity_to_number(
                    max(
                        Decimal("0"),
                        quantity_to_decimal(self.state.position.count if self.state.position else pending.count)
                        - quantity_to_decimal(fill_count),
                    )
                )
    ...
    def evaluate_mushroom_v28_common_clock_exit_guard(self, signal: ExitSignal) -> dict[str, Any]:
        ...
        shadow = self.mushroom_telemetry_fields(signal)
        reason = str(shadow.get("mushroom_v28_exit_reason") or signal.stop_tier or "")
        p_hold = as_float_or_none(shadow.get("mushroom_v28_p_hold"))
        exit_bid_cents = as_float_or_none(shadow.get("mushroom_v28_exit_bid_cents") or signal.trigger_price_cents)
        fair_drawdown = as_float_or_none(shadow.get("mushroom_v28_fair_drawdown_cents"))
        hold_book_gap = None
        if p_hold is not None and exit_bid_cents is not None:
            hold_book_gap = p_hold - (exit_bid_cents / 100.0)

        suppress = False
        guard_reason = "not_soft_exit"
        if reason == "mushroom_v28_exit_value_over_hold":
            suppress = (
                (p_hold is not None and p_hold >= 0.85)
                or (hold_book_gap is not None and hold_book_gap >= 0.0)
            )
            guard_reason = "value_p85_or_gap0" if suppress else "value_guard_failed"
        elif reason == "mushroom_v28_probability_reduce":
            suppress = (
                p_hold is not None
                and p_hold >= 0.79
                and hold_book_gap is not None
                and hold_book_gap >= 0.0
            )
            guard_reason = "reduce_p79_gap0" if suppress else "reduce_guard_failed"
        elif reason in {"mushroom_v28_probability_collapse_full", "mushroom_v28_fair_drawdown_full"}:
            guard_reason = "hard_exit_kept"
        elif reason == "mushroom_v28_fair_drawdown_reduce":
            guard_reason = "fair_drawdown_reduce_kept"

        kill_state = self.mushroom_v28_exit_guard_kill_state()
        if kill_state.get("killed"):
            suppress = False
            guard_reason = f"kill_active:{kill_state.get('reason') or 'unspecified'}"

        return {
            "candidate": "loss_guard_value_p85_reduce_p79_gap0",
            "mode": self.config.mushroom_v28_exit_guard_mode,
            "exit_reason": reason,
            "suppress_exit": bool(suppress),
            "guard_reason": guard_reason,
            "kill_state": kill_state,
            "p_hold": self._round_or_none(p_hold, 6),
            "exit_bid_cents": self._round_or_none(exit_bid_cents, 4),
            "hold_book_gap": self._round_or_none(hold_book_gap, 6),
            "fair_drawdown_cents": self._round_or_none(fair_drawdown, 6),
            "position_count": signal.position_count,
            "market_ticker": signal.market_ticker,
            "side": signal.side,
            "book_age_ms": self._round_or_none(signal.book_age_ms, 3),
            "seconds_to_close": self._round_or_none(signal.seconds_to_close, 3),
        }

    def mushroom_v28_exit_guard_kill_state(self) -> dict[str, Any]:
        if self.config.mushroom_v28_exit_guard_kill_switch:
            return {
                "killed": True,
                "reason": "manual_env_kill_switch",
                "source": "MUSHROOM_V28_EXIT_GUARD_KILL_SWITCH",
            }
        path = self.config.mushroom_v28_exit_guard_kill_state_path
        if not path.exists():
            return {
                "killed": False,
                "reason": "",
                "source": str(path),
                "max_loss_cluster": int(self.config.mushroom_v28_exit_guard_max_loss_cluster),
                "max_drawdown_cents": int(self.config.mushroom_v28_exit_guard_max_drawdown_cents),
            }
        try:
        ...
        if not isinstance(state, dict):
            return {
                "killed": True,
                "reason": "kill_state_invalid",
                "source": str(path),
            }
        killed = bool(state.get("killed") or state.get("kill") or state.get("disabled"))
        return {
            "killed": killed,
            "reason": str(state.get("reason") or state.get("kill_reason") or ""),
            "source": str(path),
            "loss_cluster": state.get("loss_cluster"),
            "drawdown_cents": state.get("drawdown_cents"),
            "accounting_mismatch": state.get("accounting_mismatch"),
            "updated_at": state.get("updated_at"),
            "max_loss_cluster": int(self.config.mushroom_v28_exit_guard_max_loss_cluster),
            "max_drawdown_cents": int(self.config.mushroom_v28_exit_guard_max_drawdown_cents),
        }

    def emit_mushroom_v28_exit_guard_shadow(self, signal: ExitSignal, guard: dict[str, Any]) -> None:
        if self.config.mushroom_v28_exit_guard_mode == "disabled":
            return
        payload = {
            "run_id": self.config.run_id,
            "strategy_tag": self.config.strategy_tag,
            "storage_tag": sanitize_strategy_tag(os.getenv("BOT_STORAGE_TAG", self.config.strategy_tag)),
            "ts_wall": utc_now().isoformat(),
            "ts_mono": round(time.monotonic(), 6),
            "event_type": "mushroom_v28_exit_guard_shadow",
            "signal_signature": signal.signal_signature,
            **guard,
        }
        self.config.mushroom_v28_exit_guard_ledger_path.parent.mkdir(parents=True, exist_ok=True)
        with self.config.mushroom_v28_exit_guard_ledger_path.open("a", encoding="utf-8") as fh:
            fh.write(json.dumps(payload, sort_keys=True) + "\n")
        self.telemetry.emit(
            "mushroom_v28_exit_guard_shadow",
            self.telemetry_context_from_exit_signal(signal),
            **guard,
            **self.orderbook.telemetry_fields(),
        )
        if self.config.mushroom_v28_exit_guard_reconciliation_enabled:
            self.write_mushroom_v28_exit_guard_exchange_reconciliation(signal, guard, stage="guard_shadow")

    def write_mushroom_v28_exit_guard_exchange_reconciliation(
        self,
        signal: ExitSignal,
        guard: dict[str, Any],
        *,
        ...
        path = self.config.mushroom_v28_exit_guard_reconciliation_path
        payload: dict[str, Any] = {
            "run_id": self.config.run_id,
            "strategy_tag": self.config.strategy_tag,
            "ts_wall": utc_now().isoformat(),
            "ts_mono": round(time.monotonic(), 6),
            "event_type": "mushroom_v28_exit_guard_exchange_reconciliation",
            "stage": stage,
            "market": signal.market_ticker,
            "side": signal.side,
            "candidate": guard.get("candidate"),
            "mode": guard.get("mode"),
            "suppress_exit": guard.get("suppress_exit"),
            "guard_reason": guard.get("guard_reason"),
            "signal_signature": signal.signal_signature,
        }
        try:
            payload["balance"] = self.client.get_balance()
            payload["positions"] = self.client.get_positions(signal.market_ticker)
            payload["resting_orders"] = self.client.get_resting_orders()
            payload["fills"] = self.client.get_fills(
                signal.market_ticker,
                limit=int(self.config.mushroom_v28_exit_guard_reconciliation_max_fills),
            )
        except Exception as exc:  # noqa: BLE001
    ...
    def mushroom_v28_entry_max_count(self, ticker: str, side: str) -> tuple[int, str]:
        ...
        if position is not None and normalize_ticker(position.market_ticker) == normalize_ticker(ticker):
            if self.mushroom_v28_lifecycle is not None:
                capped, reason = self.mushroom_v28_lifecycle.should_cap_addon(
                    market_ticker=ticker,
                    side=side,
                    current_bucket=(position.lifecycle_bucket or None),
                    current_count=float(quantity_to_decimal(position.count)),
                )
                if capped:
                    return 0, reason
            remaining_decimal = max(
                Decimal("0"),
                Decimal(str(int(self.config.multi_entry_max_position_contracts))) - quantity_to_decimal(position.count),
            )
            remaining = int(math.floor(float(remaining_decimal)))
    ...
    @staticmethod
    def mushroom_v28_feature_gate_recross_hazard(
        abs_d_sigma: float | None,
        seconds_to_close: float | None,
        sigma_t_dollars: float | None,
    ) -> float | None:
        if abs_d_sigma is None or seconds_to_close is None or sigma_t_dollars is None:
            return None
        try:
            abs_d = float(abs_d_sigma)
            seconds = float(seconds_to_close)
            sigma = float(sigma_t_dollars)
        except (TypeError, ValueError):
            return None
        if not (math.isfinite(abs_d) and math.isfinite(seconds) and math.isfinite(sigma)):
            return None
        time_factor = min(1.0, max(0.0, seconds / 900.0)) ** 0.5
        sigma_factor = min(1.5, max(0.0, sigma / 100.0))
        return math.exp(-abs_d) * time_factor * sigma_factor
    ...
    def build_mushroom_v28_decision_fields(
        ...
        *,
        ...
        raw_p_yes = float(pred.p_yes[0])
        raw_p_side = raw_p_yes if side == "yes" else (1.0 - raw_p_yes)
        raw_fair_yes = float(pred.fair_yes_cents[0])
        raw_fair_no = float(pred.fair_no_cents[0])
        raw_fair_side = raw_fair_yes if side == "yes" else raw_fair_no
        p_yes = raw_p_yes
        successor_prediction = None
        if self.mushroom_v28_successor_surface is not None:
            successor_prediction = self.mushroom_v28_successor_surface.predict(
                raw_p_yes=raw_p_yes,
                features={
            ...
            p_yes = float(successor_prediction.p_yes)
        ...
        candidate_edge_cents = fair_side - float(ask_cents)
        ...
        raw_v28_edge_cents = raw_fair_side - float(ask_cents) - fee_cents
        raw_v28_net_edge_cents = raw_v28_edge_cents - float(self.config.mushroom_v28_slippage_cents) - float(self.config.mushroom_v28_model_buffer_cents)
        ...
        raw_v28_model_max_buy_price = int(math.floor(
            raw_fair_side
            - fee_cents
            - float(self.config.mushroom_v28_slippage_cents)
            - float(self.config.mushroom_v28_model_buffer_cents)
        ...
        raw_v28_model_max_buy_price = max(1, min(99, raw_v28_model_max_buy_price))
        ...
        raw_v28_p_ok = raw_p_side >= float(self.config.mushroom_v28_min_p_side)
        raw_v28_edge_ok = raw_v28_net_edge_cents >= float(self.config.mushroom_v28_min_edge_cents_15m)
        raw_v28_model_price_ok = int(ask_cents) <= raw_v28_model_max_buy_price
        risk_ok = target_count >= 1
        min_depth_ratio = float(self.config.live_entry_fast_fill_min_depth_ratio)
        depth_required: Decimal | None = None
        depth_ratio: float | None = None
        depth_ratio_ok = True
        if min_depth_ratio > 0.0:
            intended_count = max(1, int(target_count or min(max_allowed_count or int(self.config.position_size), int(self.config.position_size))))
            depth_required = Decimal(str(intended_count)) + Decimal(
                str(
                    self.required_depth_cushion(
                        trigger_price=int(ask_cents),
                        executable_limit=int(executable_limit or ask_cents),
                        seconds_to_close=seconds_to_close,
                    )
                )
            )
            if depth_required > 0:
                depth_ratio = float(eligible_depth) / float(depth_required)
            depth_ratio_ok = depth_ratio is not None and depth_ratio >= min_depth_ratio
        feature_raw_edge_prob = p_side - (float(ask_cents) / 100.0)
        feature_ask_prob = float(ask_cents) / 100.0
        feature_recross = self.mushroom_v28_feature_gate_recross_hazard(
            abs_d_sigma,
            float(seconds_to_close),
            float(pred.sigma_t_dollars),
        )
        feature_raw_ok = feature_raw_edge_prob >= float(self.config.mushroom_v28_feature_gate_raw_edge_prob_min)
        if float(self.config.mushroom_v28_feature_gate_raw_edge_prob_min) <= -1.0:
            feature_raw_ok = True
        feature_recross_ok = (
            feature_recross is not None
            and feature_recross <= float(self.config.mushroom_v28_feature_gate_recross_max)
        )
        if float(self.config.mushroom_v28_feature_gate_recross_max) >= 999.0:
            feature_recross_ok = True
        feature_abs_d_min = float(self.config.mushroom_v28_feature_gate_abs_d_min)
        feature_abs_d_max = float(self.config.mushroom_v28_feature_gate_abs_d_max)
        feature_abs_d_min_ok = abs_d_sigma >= feature_abs_d_min
        feature_abs_d_max_ok = feature_abs_d_max <= 0.0 or abs_d_sigma <= feature_abs_d_max
        feature_abs_d_ok = bool(feature_abs_d_min_ok and feature_abs_d_max_ok)
        feature_ask_floor = float(self.config.mushroom_v28_feature_gate_ask_prob_min)
        feature_ask_ok = feature_ask_floor <= 0.0 or feature_ask_prob >= feature_ask_floor
        feature_gate_pass = bool(feature_raw_ok and feature_recross_ok and feature_abs_d_ok and feature_ask_ok)
        approved = bool(
            p_ok
            and edge_ok
            and model_price_ok
        ...
        if self.config.mushroom_v28_feature_gate_enabled:
            approved = bool(approved and feature_gate_pass)
        successor_shadow_rule_ok: bool | None = None
        raw_v28_approved = bool(
            raw_v28_p_ok
            and raw_v28_edge_ok
            and raw_v28_model_price_ok
            and ask_ok
            and book_ok
            and btc_ok
            and time_ok
        ...
        if self.config.mushroom_v28_feature_gate_enabled:
            raw_v28_approved = bool(raw_v28_approved and feature_gate_pass)
        if (
            self.mushroom_v28_successor_surface is not None
            and self.config.mushroom_v28_successor_entry_mode == "tested_shadow_rule"
        ):
            successor_shadow_rule_ok = candidate_edge_cents >= float(self.config.mushroom_v28_successor_shadow_min_edge_cents)
            approved = bool(raw_v28_approved and successor_shadow_rule_ok)
        fields.update(
            {
                "mushroom_v28_status": "ok",
                "mushroom_v28_p_yes": self._round_or_none(p_yes, 6),
                "mushroom_v28_p_side": self._round_or_none(p_side, 6),
                "mushroom_v28_raw_p_yes": self._round_or_none(raw_p_yes, 6),
                "mushroom_v28_raw_p_side": self._round_or_none(raw_p_side, 6),
                ...
                "mushroom_v28_raw_fair_yes_cents": self._round_or_none(raw_fair_yes, 6),
                "mushroom_v28_raw_fair_no_cents": self._round_or_none(raw_fair_no, 6),
                "mushroom_v28_raw_fair_side_cents": self._round_or_none(raw_fair_side, 6),
                "mushroom_v28_fee_cents": self._round_or_none(fee_cents, 4),
                "mushroom_v28_candidate_edge_cents": self._round_or_none(candidate_edge_cents, 6),
                ...
                "mushroom_v28_raw_v28_edge_cents": self._round_or_none(raw_v28_edge_cents, 6),
                "mushroom_v28_raw_v28_net_edge_cents": self._round_or_none(raw_v28_net_edge_cents, 6),
                ...
                "mushroom_v28_abs_d_sigma": self._round_or_none(abs_d_sigma, 6),
                ...
                "mushroom_v28_raw_v28_model_max_buy_price_cents": raw_v28_model_max_buy_price,
                ...
                "mushroom_v28_depth_required": format_decimal_compact(depth_required) if depth_required is not None else None,
                "mushroom_v28_depth_ratio": self._round_or_none(depth_ratio, 6),
                "mushroom_v28_depth_ratio_min": self._round_or_none(min_depth_ratio, 6),
                "mushroom_v28_depth_ratio_ok": bool(depth_ratio_ok),
                "mushroom_v28_p_ok": bool(p_ok),
                "mushroom_v28_edge_ok": bool(edge_ok),
                "mushroom_v28_model_price_ok": bool(model_price_ok),
                "mushroom_v28_raw_v28_p_ok": bool(raw_v28_p_ok),
                "mushroom_v28_raw_v28_edge_ok": bool(raw_v28_edge_ok),
                "mushroom_v28_raw_v28_model_price_ok": bool(raw_v28_model_price_ok),
                "mushroom_v28_risk_ok": bool(risk_ok),
                "mushroom_v28_balance_ok": bool(balance_ok),
                "mushroom_v28_feature_gate_enabled": bool(self.config.mushroom_v28_feature_gate_enabled),
                "mushroom_v28_feature_gate_raw_edge_prob": self._round_or_none(feature_raw_edge_prob, 6),
                "mushroom_v28_feature_gate_raw_edge_prob_min": self._round_or_none(
                    self.config.mushroom_v28_feature_gate_raw_edge_prob_min,
                    6,
                ),
                "mushroom_v28_feature_gate_recross_hazard_score": self._round_or_none(feature_recross, 6),
                "mushroom_v28_feature_gate_recross_max": self._round_or_none(
                    self.config.mushroom_v28_feature_gate_recross_max,
                    6,
                ),
                "mushroom_v28_feature_gate_abs_d_min": self._round_or_none(
                    feature_abs_d_min,
                    6,
                ),
                "mushroom_v28_feature_gate_abs_d_max": self._round_or_none(
                    feature_abs_d_max,
                    6,
                ),
                "mushroom_v28_feature_gate_ask_prob": self._round_or_none(feature_ask_prob, 6),
                "mushroom_v28_feature_gate_ask_prob_min": self._round_or_none(feature_ask_floor, 6),
                "mushroom_v28_feature_gate_raw_edge_ok": bool(feature_raw_ok),
                "mushroom_v28_feature_gate_recross_ok": bool(feature_recross_ok),
                "mushroom_v28_feature_gate_abs_d_min_ok": bool(feature_abs_d_min_ok),
                "mushroom_v28_feature_gate_abs_d_max_ok": bool(feature_abs_d_max_ok),
                "mushroom_v28_feature_gate_abs_d_ok": bool(feature_abs_d_ok),
                "mushroom_v28_feature_gate_ask_ok": bool(feature_ask_ok),
                "mushroom_v28_feature_gate_pass": bool(feature_gate_pass),
                "mushroom_v28_raw_v28_approved": bool(raw_v28_approved),
                "mushroom_v28_successor_surface_enabled": bool(self.mushroom_v28_successor_surface is not None),
                "mushroom_v28_successor_entry_mode": str(self.config.mushroom_v28_successor_entry_mode),
                "mushroom_v28_successor_shadow_rule_ok": successor_shadow_rule_ok,
                "mushroom_v28_successor_shadow_min_edge_cents": self._round_or_none(
                    self.config.mushroom_v28_successor_shadow_min_edge_cents,
                    6,
                ),
                "mushroom_v28_approved": approved,
            }
        )
        if successor_prediction is not None:
            fields.update(
                {
                    "mushroom_v28_successor_candidate_id": successor_prediction.candidate_id,
                    "mushroom_v28_successor_model_hash": successor_prediction.model_hash,
                    "mushroom_v28_successor_bucket": successor_prediction.bucket,
                    "mushroom_v28_successor_calibrated_p_yes": self._round_or_none(
                        successor_prediction.calibrated_p_yes,
                        6,
                    ),
                    "mushroom_v28_successor_corrected_p_yes": self._round_or_none(
                        successor_prediction.corrected_p_yes,
                        6,
                    ),
                    "mushroom_v28_successor_correction": self._round_or_none(successor_prediction.correction, 6),
                    "mushroom_v28_successor_correction_scale": self._round_or_none(
                        successor_prediction.correction_scale,
                        6,
                    ),
                    "mushroom_v28_successor_boundary_weight": self._round_or_none(
                        successor_prediction.boundary_weight,
                        6,
                    ),
                    "mushroom_v28_successor_time_weight": self._round_or_none(successor_prediction.time_weight, 6),
                    "mushroom_v28_successor_effective_weight": self._round_or_none(
                        successor_prediction.effective_weight,
                        6,
                    ),
                }
            )
        if self.mushroom_v28_phi_memory is not None:
            fields = self.mushroom_v28_phi_memory.apply_entry(
                market=ticker,
                fields=fields,
                trends=self.mushroom_v28_phi_trend_context(),
            )
        return fields

    def mushroom_v28_reject_reason(self, fields: dict[str, Any]) -> str:
        status = str(fields.get("mushroom_v28_status") or "")
        if status and status not in {"ok"}:
            return status
        block_reason = str(fields.get("mushroom_v28_block_reason") or "")
        if block_reason:
            return f"blocked_{block_reason}"
        checks = [
            ("time_window", "mushroom_v28_time_ok"),
            ("book_stale", "mushroom_v28_book_ok"),
            ("btc_stale", "mushroom_v28_btc_ok"),
            ("ask_too_high", "mushroom_v28_ask_ok"),
            ("p_below_floor", "mushroom_v28_p_ok"),
            ("edge_below_floor", "mushroom_v28_edge_ok"),
            ("depth_ratio", "mushroom_v28_depth_ratio_ok"),
            ("model_price_cap", "mushroom_v28_model_price_ok"),
            ("risk_or_depth", "mushroom_v28_risk_ok"),
            ("balance", "mushroom_v28_balance_ok"),
            ("feature_gate", "mushroom_v28_feature_gate_pass"),
            ("successor_shadow_rule", "mushroom_v28_successor_shadow_rule_ok"),
        ]
        for reason, key in checks:
            if fields.get(key) is False:
                return reason
        return "not_approved_unknown"

    def maybe_emit_mushroom_v28_reject_telemetry(
        self,
        *,
        ticker: str,
        side: str,
        ...
        if not self.config.mushroom_v28_reject_telemetry_enabled:
            return
        reason = self.mushroom_v28_reject_reason(fields)
        now = time.monotonic()
        key = f"{normalize_ticker(ticker)}:{side}:{reason}"
        last = self.mushroom_v28_reject_telemetry_last_emit.get(key)
        interval = max(0.0, float(self.config.mushroom_v28_reject_telemetry_interval_seconds))
        if last is not None and (now - last) < interval:
            return
        self.mushroom_v28_reject_telemetry_last_emit[key] = now
        ...
        self.telemetry.emit(
            ...
            ExecutionTelemetryContext(
                ...
                purpose="entry",
                side=side,
                trigger_price_cents=ask_cents,
                cap_price_cents=ask_cents,
                position_size=0,
                book_age_ms=book_age_ms,
                feed_age_ms=feed_age_ms,
                local_reaction_ms=local_reaction_ms,
                top_of_book_limit_cents=top_limit,
                eligible_depth=str(eligible_depth),
                book_summary=self.describe_live_buy_book(side),
                decision_reason=reason,
            ),
            mushroom_v28_reject_reason=reason,
            **fields,
            **self.orderbook.telemetry_fields(),
        )
    ...
    def detect_mushroom_v28_entry_signal(self) -> EntrySignal | None:
        ...
        for side in ("yes", "no"):
            ...
            if not fields.get("mushroom_v28_approved"):
                self.maybe_emit_mushroom_v28_reject_telemetry(
                    ticker=ticker,
                    side=side,
                    ask_cents=int(ask_cents) if ask_cents is not None else None,
                    top_limit=top_limit,
    ...
    def build_live_entry_plan(self, *, signal: EntrySignal) -> LiveFillPlan | None:
        ...
        if not self.config.dry_run:
            ...
            if account_age_ms > self.config.live_account_state_max_age_ms:
                self.defer_execution(signal, "missing_account_state")
                return None
            nonzero_positions = nonzero_live_positions(self.live_account_snapshot.positions)
            exchange_position_conflict = live_account_position_conflict_reason(nonzero_positions, self.state.position)
            if exchange_position_conflict:
                self.defer_execution(
                    signal,
                    exchange_position_conflict,
                    exchange_position_count=len(nonzero_positions),
                    exchange_position_tickers=",".join(live_position_ticker(pos) or "UNKNOWN" for pos in nonzero_positions),
                )
                return None
        ...
        if self.config.live_entry_fast_fill_gate_enabled:
            ...
            if min_depth_ratio > 0.0:
                depth_ratio = None
                if depth_required and depth_required > 0:
                    depth_ratio = float(eligible_depth) / float(depth_required)
                if depth_ratio is None or depth_ratio < min_depth_ratio:
                    self.defer_execution(
                        signal,
                        "fast_fill_insufficient_depth_ratio",
                        gate_min_depth_ratio=min_depth_ratio,
                        gate_depth_ratio=depth_ratio,
                        gate_eligible_depth=str(eligible_depth),
                        gate_depth_required=str(depth_required),
                    )
                    return None
    ...
    async def continue_partial_entry_completion(
        ...
        *,
        total_filled: int | float,
        first_order_id: str,
    ) -> tuple[int | float, str]:
        if (
            not quantity_positive(total_filled)
            or quantity_to_decimal(total_filled) + QUANTITY_EPSILON >= quantity_to_decimal(plan.total_count)
            or not self.config.live_entry_partial_completion_enabled
        ):
        ...
        attempt = 0
        while quantity_to_decimal(total_filled) + QUANTITY_EPSILON < quantity_to_decimal(plan.total_count) and time.monotonic() < deadline:
            remaining_decimal = max(Decimal("0"), quantity_to_decimal(plan.total_count) - quantity_to_decimal(total_filled))
            remaining = max(0, math.ceil(float(remaining_decimal)))
            ...
            if submission.error_text:
                ...
                break
            if quantity_positive(submission.fill_count):
                ...
                entry_fee_cents = (
                    ...
                    else self.estimated_order_fee_cents(int(round(float(entry_fill_cents))), max(1, math.ceil(float(quantity_to_decimal(submission.fill_count)))))
                )
                self.record_entry_fill_for_outcomes(
                    market_ticker=plan.market_ticker,
                    side=plan.side,
                ...
                total_filled = quantity_to_number(quantity_to_decimal(total_filled) + quantity_to_decimal(submission.fill_count))
                position = self.apply_entry_fill_to_position(
                    market_ticker=plan.market_ticker,
                    side=plan.side,
                    fill_count=submission.fill_count,
                    ...
                    entry_context=plan.mushroom_shadow,
                )
                if (
                    self.post_entry_shadow_watch is not None
                ...
                self.save_state()
                self.telemetry.emit(
                    "fill_partial" if quantity_to_decimal(total_filled) + QUANTITY_EPSILON < quantity_to_decimal(plan.total_count) else "fill_full",
                ...
                self.logger.info(
                    ...
                    total_filled,
                    format_quantity(max(Decimal("0"), quantity_to_decimal(plan.total_count) - quantity_to_decimal(total_filled))),
                    limit_cents,
                )
            if retry_delay_seconds > 0 and quantity_to_decimal(total_filled) + QUANTITY_EPSILON < quantity_to_decimal(plan.total_count):
                await asyncio.sleep(retry_delay_seconds)
        return total_filled, first_order_id

    def build_exit_slice_plans(self, plan: ExitPlan) -> list[SlicePlan]:
        total = max(1, math.ceil(float(quantity_to_decimal(plan.total_count))))
        ...
        try:
            ...
            for slice_plan in plan.slices:
                ...
                if submission.error_text:
                    ...
                    break
                if not quantity_positive(submission.fill_count) and self.config.live_entry_slice_stop_on_zero_fill:
            ...
            if total_filled > 0:
                ...
                self.entry_retry_block_until_monotonic = time.monotonic() + max(
                    0.0,
                    float(self.config.live_entry_blocked_suppression_ms) / 1000.0,
                )
                self.transition_execution_state(plan.market_ticker, plan.side, "abandoned", "zero_fill", plan.signal_signature)
        finally:
            self.order_inflight = False

    async def reconcile_recent_fills_for_order(
        self,
        *,
        market_ticker: str,
        order_id: str,
        ...
        if self.config.dry_run:
            return None
        # Kalshi can report a fast IOC as canceled/zero-fill while a tiny fill
        # is already visible on the fills endpoint. Re-sample briefly before
        # the local state accepts a true zero.
        for attempt in range(3):
            ...
            try:
                fills = await asyncio.to_thread(
                    ...
                    market_ticker,
                    max(10, int(self.config.mushroom_v28_exit_guard_reconciliation_max_fills)),
                )
            except Exception as exc:  # noqa: BLE001
                self.logger.warning(
                    "Fill reconciliation lookup failed | market=%s order_id=%s attempt=%s error=%s",
                    market_ticker,
                    order_id,
                    attempt + 1,
                    exc,
            ...
            if summary is not None and quantity_positive(summary.get("fill_count")):
                requested = quantity_to_decimal(requested_count)
                recovered = quantity_to_decimal(summary.get("fill_count"))
                summary["remaining_count"] = quantity_to_number(max(Decimal("0"), requested - recovered))
                return summary
        return None
    ...
    async def submit_single_order(
        ...
        *,
        ...
        if (
            not quantity_positive(fill_count)
            and order_id
            and str(order.get("status") or "").lower() in {"canceled", "cancelled", "executed", "filled"}
        ):
            fill_summary = await self.reconcile_recent_fills_for_order(
                market_ticker=market_ticker,
                order_id=order_id,
            ...
            if fill_summary is not None:
                ...
                actual_fee_cents = fill_summary["actual_fee_cents"]
                self.logger.warning(
                    "Recovered exchange fill after zero-fill order response | market=%s side=%s order_id=%s qty=%s fill=%sc fee=%sc fill_ids=%s",
                    market_ticker,
                    side,
                    order_id,
                    format_quantity(fill_count),
        ...
        if (
            ...
            and not quantity_positive(result.fill_count)
            and result.status in {"canceled", "cancelled"}
        ):
    ...
    async def maybe_refresh_live_account_state(self, *, force: bool = False) -> None:
        ...
        try:
            balance_raw, resting_orders, positions = await asyncio.gather(
        ...
        try:
            ...
            if pending.purpose == "entry":
                if matching_position is not None:
                    live_qty_raw = parse_contract_quantity(
                        matching_position.get("position_fp", matching_position.get("position", 0)),
                        fixed_point=False,
                    ) or Decimal(str(pending.count))
                    live_qty = abs(live_qty_raw)
                    existing = self.state.position
                    existing_qty = (
                        quantity_to_decimal(existing.count)
                        if existing is not None
                        and normalize_ticker(existing.market_ticker) == normalize_ticker(pending.market_ticker)
                        and existing.side == pending.side
                        else Decimal("0")
                    )
                    fill_delta = max(Decimal("0"), live_qty - existing_qty)
                    fill_delta_number = quantity_to_number(fill_delta)
                    estimated_fee_cents = self.estimated_order_fee_cents(int(pending.limit_price_cents), max(1, math.ceil(float(fill_delta or Decimal(str(pending.count))))))
                    if fill_delta > QUANTITY_EPSILON:
                        self.record_entry_fill_for_outcomes(
                            market_ticker=pending.market_ticker,
                            side=pending.side,
                            fill_count=fill_delta_number,
    ...
    def detect_mushroom_v28_exit_signal(self, position: PositionState, filled_at: datetime) -> ExitSignal | None:
        ...
        qty = max(1, math.ceil(float(quantity_to_decimal(position.count))))
        ...
        shadow = {
            "mushroom_v28_version": MUSHROOM_V28_VERSION,
            "mushroom_v28_side": position.side,
            ...
            "mushroom_v28_exit_reduce_p_hold_floor": self._round_or_none(self.config.mushroom_v28_exit_reduce_p_hold_floor, 6),
            "mushroom_v28_exit_full_p_hold_floor": self._round_or_none(self.config.mushroom_v28_exit_full_p_hold_floor, 6),
            "mushroom_v28_exit_fair_drawdown_cents": self._round_or_none(self.config.mushroom_v28_exit_fair_drawdown_cents, 4),
            "mushroom_v28_exit_full_drawdown_cents": self._round_or_none(self.config.mushroom_v28_exit_full_drawdown_cents, 4),
            "mushroom_v28_exit_reduce_fraction": self._round_or_none(self.config.mushroom_v28_exit_reduce_fraction, 6),
        ...
        if self.mushroom_v28_phi_memory is not None:
            shadow = self.mushroom_v28_phi_memory.apply_exit(
                market=position.market_ticker,
                fields=shadow,
                trends=self.mushroom_v28_phi_trend_context(),
            )
            reason = str(shadow.get("mushroom_v28_exit_reason") or "")
            target_count = int(shadow.get("mushroom_v28_exit_target_count") or 0)
            if (
                raw_reason
                and not reason
                and str(shadow.get("mushroom_v28_phi_memory_effective_mode") or "") == "enforce"
                and int(top_bid) >= int(self.config.mushroom_v28_phi_memory_rich_exit_recheck_bid_cents)
            ):
                recheck_key = f"{normalize_ticker(position.market_ticker)}:{position.side}:{raw_reason}"
                now_mono = time.monotonic()
                first_seen = self.mushroom_v28_phi_memory_exit_rechecks.get(recheck_key)
                if first_seen is None:
                    self.mushroom_v28_phi_memory_exit_rechecks[recheck_key] = now_mono
                    if self.mushroom_v28_phi_memory is not None:
                        self.mushroom_v28_phi_memory.log_event(
                            "rich_exit_recheck",
                            market=position.market_ticker,
                            side=position.side,
                            raw_reason=raw_reason,
                            top_bid_cents=int(top_bid),
                            action="defer_once",
                        )
                    return None
                if now_mono - first_seen < float(self.config.mushroom_v28_phi_memory_rich_exit_recheck_seconds):
                    return None
                reason = raw_reason
                target_count = raw_target_count
                shadow["mushroom_v28_exit_reason"] = raw_reason
                shadow["mushroom_v28_exit_target_count"] = raw_target_count
                shadow["mushroom_v28_phi_memory_rich_exit_recheck_result"] = "raw_exit_after_recheck"
                self.mushroom_v28_phi_memory_exit_rechecks.pop(recheck_key, None)
        if self.mushroom_v28_adaptive_exit_supervisor is not None:
            shadow, adaptive_defer = self.mushroom_v28_adaptive_exit_supervisor.apply_exit(
                market=position.market_ticker,
                fields=shadow,
            )
            reason = str(shadow.get("mushroom_v28_exit_reason") or "")
            ...
            if adaptive_defer:
                return None
        if self.mushroom_v28_lifecycle is not None:
            shadow, lifecycle_defer = self.mushroom_v28_lifecycle.apply_exit(
                market_ticker=position.market_ticker,
                side=position.side,
                fields=shadow,
                position_bucket=(position.lifecycle_bucket or None),
            )
            reason = str(shadow.get("mushroom_v28_exit_reason") or "")
            target_count = int(shadow.get("mushroom_v28_exit_target_count") or 0)
            if lifecycle_defer:
        ...
        shadow.update({
            "mushroom_v28_exit_reason": reason,
            "mushroom_v28_exit_target_count": target_count,
            "mushroom_v28_exit_executable_limit_cents": executable_limit,
            "mushroom_v28_exit_eligible_depth": format_decimal_compact(eligible_depth),
        })
        signal_signature = "|".join(
            [
                reason,
        ...
        return ExitSignal(
            ...
            stop_price_cents=int(round(float(shadow.get("mushroom_v28_fair_hold_cents") or fair_hold))),
    ...
    def estimate_exit_capacity(self, signal: ExitSignal) -> ExitCapacityEstimate:
        qty = max(1, math.ceil(float(quantity_to_decimal(signal.position_count))))
            ...
            while True:
                ...
                for slice_plan in slices:
                    ...
                    if slice_plan.slice_index > 0 and not self.exit_slice_continuation_is_valid(current_plan, slice_plan):
                        ...
                        break
                    current_remaining = self.state.position.count if self.state.position else quantity_to_number(
                        max(Decimal("0"), quantity_to_decimal(current_plan.total_count) - quantity_to_decimal(total_filled))
                    )
                    if not quantity_positive(current_remaining):
                        return
                    submit_count = min(slice_plan.count, max(1, math.ceil(float(quantity_to_decimal(current_remaining)))))
                    ...
                    if submission.error_text:
                        ...
                        break
                    if not quantity_positive(submission.fill_count) and submission.status in {"canceled", "cancelled"}:
                    ...
                    if quantity_positive(submission.fill_count):
                        self.telemetry.emit(
                            "exit_submit_partial" if quantity_to_decimal(submission.fill_count) + QUANTITY_EPSILON < quantity_to_decimal(effective_slice.count) else "exit_submit_full",
                            self.telemetry_context_from_exit_plan(current_plan, submission=submission, slice_plan=effective_slice),
                            cumulative_fill_count=total_filled,
                    ...
                    if quantity_positive(submission.fill_count):
                        remaining_position = quantity_to_number(
                            max(
                                Decimal("0"),
                                quantity_to_decimal(self.state.position.count if self.state.position else current_plan.total_count)
                                - quantity_to_decimal(submission.fill_count),
                            )
                        )
                        self.record_exit_fill_for_outcomes(
                            market_ticker=current_plan.market_ticker,
                    ...
                    if quantity_to_decimal(total_filled) + QUANTITY_EPSILON >= quantity_to_decimal(plan.total_count) or self.state.position is None:
                        return
                if quantity_to_decimal(total_filled) + QUANTITY_EPSILON >= quantity_to_decimal(plan.total_count) or self.state.position is None:
                    return
    ...
    async def maybe_check_exit(self) -> None:
        ...
        if self.config.mushroom_v28_live_exit_enabled:
            ...
            if signal is not None:
                guard = self.evaluate_mushroom_v28_common_clock_exit_guard(signal)
                self.emit_mushroom_v28_exit_guard_shadow(signal, guard)
                if (
                    self.config.mushroom_v28_exit_guard_mode == "enforce"
                    and guard.get("suppress_exit")
                ):
                    self.telemetry.emit(
                        "exit_execution_deferred",
                        self.telemetry_context_from_exit_signal(signal),
                        result="mushroom_v28_exit_guard_suppressed",
                        exit_source="mushroom_v28_ev",
                        **guard,
                        **self.orderbook.telemetry_fields(),
                    )
                    return
    ...
    async def submit_order(
        ...
        *,
        ...
        try:
            ...
            self.save_state()
            if not quantity_positive(fill_count) and status in {"canceled", "cancelled"}:
                self.logger.warning(
                ...
                return
            if quantity_positive(fill_count) and (
                quantity_to_decimal(fill_count) + QUANTITY_EPSILON >= quantity_to_decimal(count)
                or status in {"executed", "filled", "canceled", "cancelled"}
            ):
                if purpose == "entry":
                    entry_fill_cents = actual_fill_price_cents or limit_price_cents
                    entry_fee_cents = actual_fee_cents if actual_fee_cents is not None else self.estimated_order_fee_cents(entry_fill_cents, max(1, math.ceil(float(quantity_to_decimal(fill_count)))))
                    self.record_entry_fill_for_outcomes(
                        market_ticker=market_ticker,
                        side=side,
                        fill_count=fill_count,
                    ...
                    remaining_position = quantity_to_number(
                        max(
                            Decimal("0"),
                            quantity_to_decimal(self.state.position.count if self.state.position else count)
                            - quantity_to_decimal(fill_count),
                        )
                    )
                    if actual_fill_price_cents is not None:
...
def load_config() -> Config:
    ...
    mushroom_v28_exit_guard_ledger_path = Path(
        os.getenv(
            "MUSHROOM_V28_EXIT_GUARD_LEDGER_PATH",
            str(SCRIPT_DIR / "logs" / storage_tag / "mushroom_v28_exit_guard_shadow.ndjson"),
        )
    ).expanduser()
    if not mushroom_v28_exit_guard_ledger_path.is_absolute():
        mushroom_v28_exit_guard_ledger_path = (SCRIPT_DIR / mushroom_v28_exit_guard_ledger_path).resolve()
    mushroom_v28_exit_guard_kill_state_path = Path(
        os.getenv(
            "MUSHROOM_V28_EXIT_GUARD_KILL_STATE_PATH",
            str(SCRIPT_DIR / "state" / storage_tag / "mushroom_v28_exit_guard_kill_state.json"),
        )
    ).expanduser()
    if not mushroom_v28_exit_guard_kill_state_path.is_absolute():
        mushroom_v28_exit_guard_kill_state_path = (SCRIPT_DIR / mushroom_v28_exit_guard_kill_state_path).resolve()
    mushroom_v28_exit_guard_reconciliation_path = Path(
        os.getenv(
            "MUSHROOM_V28_EXIT_GUARD_RECONCILIATION_PATH",
            str(SCRIPT_DIR / "logs" / storage_tag / "exchange_reconciliation.ndjson"),
        )
    ).expanduser()
    if not mushroom_v28_exit_guard_reconciliation_path.is_absolute():
        mushroom_v28_exit_guard_reconciliation_path = (SCRIPT_DIR / mushroom_v28_exit_guard_reconciliation_path).resolve()
    mushroom_v28_phi_memory_state_path = Path(
        os.getenv(
            "MUSHROOM_V28_PHI_MEMORY_STATE_PATH",
            str(SCRIPT_DIR / "state" / storage_tag / "v28_phi_reward_memory_state.json"),
        )
    ).expanduser()
    if not mushroom_v28_phi_memory_state_path.is_absolute():
        mushroom_v28_phi_memory_state_path = (SCRIPT_DIR / mushroom_v28_phi_memory_state_path).resolve()
    mushroom_v28_phi_memory_log_path = Path(
        os.getenv(
            "MUSHROOM_V28_PHI_MEMORY_LOG_PATH",
            str(SCRIPT_DIR / "logs" / storage_tag / "v28_phi_reward_memory.ndjson"),
        )
    ).expanduser()
    if not mushroom_v28_phi_memory_log_path.is_absolute():
        mushroom_v28_phi_memory_log_path = (SCRIPT_DIR / mushroom_v28_phi_memory_log_path).resolve()
    mushroom_v28_adaptive_exit_state_path = Path(
        os.getenv(
            "MUSHROOM_V28_ADAPTIVE_EXIT_STATE_PATH",
            str(SCRIPT_DIR / "state" / storage_tag / "v28_adaptive_exit_supervisor_state.json"),
        )
    ).expanduser()
    if not mushroom_v28_adaptive_exit_state_path.is_absolute():
        mushroom_v28_adaptive_exit_state_path = (SCRIPT_DIR / mushroom_v28_adaptive_exit_state_path).resolve()
    mushroom_v28_adaptive_exit_log_path = Path(
        os.getenv(
            "MUSHROOM_V28_ADAPTIVE_EXIT_LOG_PATH",
            str(SCRIPT_DIR / "logs" / storage_tag / "v28_adaptive_exit_supervisor.ndjson"),
        )
    ).expanduser()
    if not mushroom_v28_adaptive_exit_log_path.is_absolute():
        mushroom_v28_adaptive_exit_log_path = (SCRIPT_DIR / mushroom_v28_adaptive_exit_log_path).resolve()
    mushroom_v28_lifecycle_state_path = Path(
        os.getenv(
            "MUSHROOM_V28_LIFECYCLE_STATE_PATH",
            str(SCRIPT_DIR / "state" / storage_tag / "v28_trade_lifecycle_state.json"),
        )
    ).expanduser()
    if not mushroom_v28_lifecycle_state_path.is_absolute():
        mushroom_v28_lifecycle_state_path = (SCRIPT_DIR / mushroom_v28_lifecycle_state_path).resolve()
    mushroom_v28_lifecycle_log_path = Path(
        os.getenv(
            "MUSHROOM_V28_LIFECYCLE_LOG_PATH",
            str(SCRIPT_DIR / "logs" / storage_tag / "v28_trade_lifecycle.ndjson"),
        )
    ).expanduser()
    if not mushroom_v28_lifecycle_log_path.is_absolute():
        mushroom_v28_lifecycle_log_path = (SCRIPT_DIR / mushroom_v28_lifecycle_log_path).resolve()
    mushroom_v28_successor_manifest_path = Path(
        os.getenv("MUSHROOM_V28_SUCCESSOR_MANIFEST_PATH", str(V28_SUCCESSOR_DEFAULT_MANIFEST_PATH))
    ).expanduser()
    if not mushroom_v28_successor_manifest_path.is_absolute():
        mushroom_v28_successor_manifest_path = (SCRIPT_DIR / mushroom_v28_successor_manifest_path).resolve()
    ...
    config = Config(
        ...
        live_entry_fast_fill_min_depth_ratio=float(os.getenv("LIVE_ENTRY_FAST_FILL_MIN_DEPTH_RATIO", "0")),
        ...
        mushroom_v28_btc_ws_stale_reconnect_ms=float(os.getenv("MUSHROOM_V28_BTC_WS_STALE_RECONNECT_MS", "0")),
        mushroom_v28_btc_rest_fallback_enabled=parse_bool(os.getenv("MUSHROOM_V28_BTC_REST_FALLBACK_ENABLED", "false")),
        mushroom_v28_btc_rest_fallback_url=os.getenv(
            "MUSHROOM_V28_BTC_REST_FALLBACK_URL",
            "https://api.coinbase.com/v2/prices/BTC-USD/spot",
        ).strip(),
        mushroom_v28_btc_rest_fallback_min_interval_ms=float(os.getenv("MUSHROOM_V28_BTC_REST_FALLBACK_MIN_INTERVAL_MS", "1000")),
        mushroom_v28_feature_gate_enabled=parse_bool(os.getenv("MUSHROOM_V28_FEATURE_GATE_ENABLED", "false")),
        mushroom_v28_feature_gate_raw_edge_prob_min=float(os.getenv("MUSHROOM_V28_FEATURE_GATE_RAW_EDGE_PROB_MIN", "0.05")),
        mushroom_v28_feature_gate_recross_max=float(os.getenv("MUSHROOM_V28_FEATURE_GATE_RECROSS_MAX", "0.60")),
        mushroom_v28_feature_gate_abs_d_min=float(os.getenv("MUSHROOM_V28_FEATURE_GATE_ABS_D_MIN", "0.85")),
        mushroom_v28_feature_gate_abs_d_max=float(os.getenv("MUSHROOM_V28_FEATURE_GATE_ABS_D_MAX", "0.0")),
        mushroom_v28_feature_gate_ask_prob_min=float(os.getenv("MUSHROOM_V28_FEATURE_GATE_ASK_PROB_MIN", "0.0")),
        mushroom_v28_successor_surface_enabled=parse_bool(os.getenv("MUSHROOM_V28_SUCCESSOR_SURFACE_ENABLED", "false")),
        mushroom_v28_successor_manifest_path=mushroom_v28_successor_manifest_path,
        mushroom_v28_successor_candidate_id=os.getenv(
            "MUSHROOM_V28_SUCCESSOR_CANDIDATE_ID",
            DEFAULT_V28_SUCCESSOR_CANDIDATE_ID,
        ).strip(),
        mushroom_v28_successor_model_hash=os.getenv(
            "MUSHROOM_V28_SUCCESSOR_MODEL_HASH",
            DEFAULT_V28_SUCCESSOR_MODEL_HASH,
        ).strip(),
        mushroom_v28_successor_entry_mode=os.getenv(
            "MUSHROOM_V28_SUCCESSOR_ENTRY_MODE",
            "overlay_probability",
        ).strip().lower(),
        mushroom_v28_successor_shadow_min_edge_cents=float(os.getenv("MUSHROOM_V28_SUCCESSOR_SHADOW_MIN_EDGE_CENTS", "1.0")),
        ...
        mushroom_v28_exit_guard_mode=os.getenv("MUSHROOM_V28_EXIT_GUARD_MODE", "disabled").strip().lower(),
        mushroom_v28_exit_guard_ledger_path=mushroom_v28_exit_guard_ledger_path,
        mushroom_v28_exit_guard_kill_switch=parse_bool(os.getenv("MUSHROOM_V28_EXIT_GUARD_KILL_SWITCH", "false")),
        mushroom_v28_exit_guard_kill_state_path=mushroom_v28_exit_guard_kill_state_path,
        mushroom_v28_exit_guard_max_loss_cluster=int(os.getenv("MUSHROOM_V28_EXIT_GUARD_MAX_LOSS_CLUSTER", "3")),
        mushroom_v28_exit_guard_max_drawdown_cents=int(os.getenv("MUSHROOM_V28_EXIT_GUARD_MAX_DRAWDOWN_CENTS", "200")),
        mushroom_v28_exit_guard_reconciliation_enabled=parse_bool(os.getenv("MUSHROOM_V28_EXIT_GUARD_RECONCILIATION_ENABLED", "false")),
        mushroom_v28_exit_guard_reconciliation_path=mushroom_v28_exit_guard_reconciliation_path,
        mushroom_v28_exit_guard_reconciliation_max_fills=int(os.getenv("MUSHROOM_V28_EXIT_GUARD_RECONCILIATION_MAX_FILLS", "100")),
        mushroom_v28_phi_memory_enabled=parse_bool(os.getenv("MUSHROOM_V28_PHI_MEMORY_ENABLED", "false")),
        mushroom_v28_phi_memory_mode=os.getenv("MUSHROOM_V28_PHI_MEMORY_MODE", "shadow").strip().lower(),
        mushroom_v28_phi_memory_state_path=mushroom_v28_phi_memory_state_path,
        mushroom_v28_phi_memory_log_path=mushroom_v28_phi_memory_log_path,
        mushroom_v28_phi_memory_entry_cap_cents=float(os.getenv("MUSHROOM_V28_PHI_MEMORY_ENTRY_CAP_CENTS", "1.0")),
        mushroom_v28_phi_memory_exit_cap_cents=float(os.getenv("MUSHROOM_V28_PHI_MEMORY_EXIT_CAP_CENTS", "2.0")),
        mushroom_v28_phi_memory_allow_add_entries=parse_bool(os.getenv("MUSHROOM_V28_PHI_MEMORY_ALLOW_ADD_ENTRIES", "true")),
        mushroom_v28_phi_memory_allow_size_increase=parse_bool(os.getenv("MUSHROOM_V28_PHI_MEMORY_ALLOW_SIZE_INCREASE", "true")),
        mushroom_v28_phi_memory_allow_side_flip_live=parse_bool(os.getenv("MUSHROOM_V28_PHI_MEMORY_ALLOW_SIDE_FLIP_LIVE", "false")),
        mushroom_v28_phi_memory_kill_switch=parse_bool(os.getenv("MUSHROOM_V28_PHI_MEMORY_KILL_SWITCH", "false")),
        mushroom_v28_phi_memory_kill_net_pnl_dollars=float(os.getenv("MUSHROOM_V28_PHI_MEMORY_KILL_NET_PNL_DOLLARS", "-4.0")),
        mushroom_v28_phi_memory_kill_loss_cluster=int(os.getenv("MUSHROOM_V28_PHI_MEMORY_KILL_LOSS_CLUSTER", "6")),
        mushroom_v28_phi_memory_near_edge_min_cents=float(os.getenv("MUSHROOM_V28_PHI_MEMORY_NEAR_EDGE_MIN_CENTS", "2.0")),
        mushroom_v28_phi_memory_near_depth_ratio_min=float(os.getenv("MUSHROOM_V28_PHI_MEMORY_NEAR_DEPTH_RATIO_MIN", "6.0")),
        mushroom_v28_phi_memory_required_depth_ratio=float(os.getenv("MUSHROOM_V28_PHI_MEMORY_REQUIRED_DEPTH_RATIO", os.getenv("LIVE_ENTRY_FAST_FILL_MIN_DEPTH_RATIO", "8.0"))),
        mushroom_v28_phi_memory_near_abs_d_min=float(os.getenv("MUSHROOM_V28_PHI_MEMORY_NEAR_ABS_D_MIN", "0.75")),
        mushroom_v28_phi_memory_near_abs_d_max=float(os.getenv("MUSHROOM_V28_PHI_MEMORY_NEAR_ABS_D_MAX", "1.15")),
        mushroom_v28_phi_memory_rich_exit_recheck_bid_cents=int(os.getenv("MUSHROOM_V28_PHI_MEMORY_RICH_EXIT_RECHECK_BID_CENTS", "80")),
        mushroom_v28_phi_memory_rich_exit_recheck_seconds=float(os.getenv("MUSHROOM_V28_PHI_MEMORY_RICH_EXIT_RECHECK_SECONDS", "5")),
        mushroom_v28_phi_memory_report_interval_seconds=float(os.getenv("MUSHROOM_V28_PHI_MEMORY_REPORT_INTERVAL_SECONDS", "900")),
        mushroom_v28_adaptive_exit_enabled=parse_bool(os.getenv("MUSHROOM_V28_ADAPTIVE_EXIT_ENABLED", "false")),
        mushroom_v28_adaptive_exit_mode=os.getenv("MUSHROOM_V28_ADAPTIVE_EXIT_MODE", "shadow").strip().lower(),
        mushroom_v28_adaptive_exit_state_path=mushroom_v28_adaptive_exit_state_path,
        mushroom_v28_adaptive_exit_log_path=mushroom_v28_adaptive_exit_log_path,
        mushroom_v28_adaptive_exit_cheap_no_entry_max_cents=float(os.getenv("MUSHROOM_V28_ADAPTIVE_EXIT_CHEAP_NO_ENTRY_MAX_CENTS", "15.0")),
        mushroom_v28_adaptive_exit_reduce_fraction=float(os.getenv("MUSHROOM_V28_ADAPTIVE_EXIT_REDUCE_FRACTION", "0.5")),
        mushroom_v28_adaptive_exit_recheck_seconds=float(os.getenv("MUSHROOM_V28_ADAPTIVE_EXIT_RECHECK_SECONDS", "5.0")),
        mushroom_v28_adaptive_exit_panic_p_hold_floor=float(os.getenv("MUSHROOM_V28_ADAPTIVE_EXIT_PANIC_P_HOLD_FLOOR", "0.03")),
        mushroom_v28_adaptive_exit_disable_min_observations=int(os.getenv("MUSHROOM_V28_ADAPTIVE_EXIT_DISABLE_MIN_OBSERVATIONS", "3")),
        mushroom_v28_adaptive_exit_disable_delta_cents=float(os.getenv("MUSHROOM_V28_ADAPTIVE_EXIT_DISABLE_DELTA_CENTS", "-150.0")),
        mushroom_v28_adaptive_exit_restore_min_observations=int(os.getenv("MUSHROOM_V28_ADAPTIVE_EXIT_RESTORE_MIN_OBSERVATIONS", "5")),
        mushroom_v28_adaptive_exit_restore_delta_cents=float(os.getenv("MUSHROOM_V28_ADAPTIVE_EXIT_RESTORE_DELTA_CENTS", "150.0")),
        mushroom_v28_lifecycle_enabled=parse_bool(os.getenv("MUSHROOM_V28_LIFECYCLE_ENABLED", "false")),
        mushroom_v28_lifecycle_mode=os.getenv("MUSHROOM_V28_LIFECYCLE_MODE", "shadow").strip().lower(),
        mushroom_v28_lifecycle_state_path=mushroom_v28_lifecycle_state_path,
        mushroom_v28_lifecycle_log_path=mushroom_v28_lifecycle_log_path,
        mushroom_v28_lifecycle_exit_toll_cents=float(os.getenv("MUSHROOM_V28_LIFECYCLE_EXIT_TOLL_CENTS", "2.5")),
        mushroom_v28_lifecycle_recheck_seconds=float(os.getenv("MUSHROOM_V28_LIFECYCLE_RECHECK_SECONDS", "5")),
        mushroom_v28_lifecycle_cheap_entry_max_cents=float(os.getenv("MUSHROOM_V28_LIFECYCLE_CHEAP_ENTRY_MAX_CENTS", "15")),
        mushroom_v28_lifecycle_promote_delta_cents=float(os.getenv("MUSHROOM_V28_LIFECYCLE_PROMOTE_DELTA_CENTS", "100")),
        mushroom_v28_lifecycle_disable_bad_settles=int(os.getenv("MUSHROOM_V28_LIFECYCLE_DISABLE_BAD_SETTLES", "3")),
        mushroom_v28_lifecycle_min_promote_observations=int(os.getenv("MUSHROOM_V28_LIFECYCLE_MIN_PROMOTE_OBSERVATIONS", "5")),
        mushroom_v28_reject_telemetry_enabled=parse_bool(os.getenv("MUSHROOM_V28_REJECT_TELEMETRY_ENABLED", "false")),
        mushroom_v28_reject_telemetry_interval_seconds=float(os.getenv("MUSHROOM_V28_REJECT_TELEMETRY_INTERVAL_SECONDS", "20")),
...
def validate_config(config: Config) -> None:
    ...
    if int(config.post_fill_exit_delay_seconds) not in {30, 90}:
        raise ValueError("POST_FILL_EXIT_DELAY_SECONDS must remain 30 or the versioned exitdelay90 trial value")
    ...
    if config.live_entry_fast_fill_min_depth_ratio < 0:
        raise ValueError("LIVE_ENTRY_FAST_FILL_MIN_DEPTH_RATIO must be non-negative")
    ...
    if config.mushroom_v28_phi_memory_mode not in {"shadow", "enforce"}:
        raise ValueError("MUSHROOM_V28_PHI_MEMORY_MODE must be shadow or enforce")
    if config.mushroom_v28_phi_memory_entry_cap_cents < 0:
        raise ValueError("MUSHROOM_V28_PHI_MEMORY_ENTRY_CAP_CENTS must be non-negative")
    if config.mushroom_v28_phi_memory_exit_cap_cents < 0:
        raise ValueError("MUSHROOM_V28_PHI_MEMORY_EXIT_CAP_CENTS must be non-negative")
    if config.mushroom_v28_phi_memory_required_depth_ratio < 0:
        raise ValueError("MUSHROOM_V28_PHI_MEMORY_REQUIRED_DEPTH_RATIO must be non-negative")
    if config.mushroom_v28_adaptive_exit_mode not in {"shadow", "enforce"}:
        raise ValueError("MUSHROOM_V28_ADAPTIVE_EXIT_MODE must be shadow or enforce")
    if config.mushroom_v28_adaptive_exit_cheap_no_entry_max_cents <= 0:
        raise ValueError("MUSHROOM_V28_ADAPTIVE_EXIT_CHEAP_NO_ENTRY_MAX_CENTS must be positive")
    if not 0 < config.mushroom_v28_adaptive_exit_reduce_fraction <= 1:
        raise ValueError("MUSHROOM_V28_ADAPTIVE_EXIT_REDUCE_FRACTION must be in (0, 1]")
    if config.mushroom_v28_adaptive_exit_recheck_seconds < 0:
        raise ValueError("MUSHROOM_V28_ADAPTIVE_EXIT_RECHECK_SECONDS must be non-negative")
    if config.mushroom_v28_adaptive_exit_panic_p_hold_floor < 0:
        raise ValueError("MUSHROOM_V28_ADAPTIVE_EXIT_PANIC_P_HOLD_FLOOR must be non-negative")
    if config.mushroom_v28_lifecycle_mode not in {"shadow", "exit_only_enforce", "full_enforce"}:
        raise ValueError("MUSHROOM_V28_LIFECYCLE_MODE must be shadow, exit_only_enforce, or full_enforce")
    if config.mushroom_v28_lifecycle_exit_toll_cents < 0:
        raise ValueError("MUSHROOM_V28_LIFECYCLE_EXIT_TOLL_CENTS must be non-negative")
    if config.mushroom_v28_lifecycle_recheck_seconds < 0:
        raise ValueError("MUSHROOM_V28_LIFECYCLE_RECHECK_SECONDS must be non-negative")
    if config.mushroom_v28_lifecycle_cheap_entry_max_cents <= 0:
        raise ValueError("MUSHROOM_V28_LIFECYCLE_CHEAP_ENTRY_MAX_CENTS must be positive")
    if config.mushroom_v28_lifecycle_promote_delta_cents < 0:
        raise ValueError("MUSHROOM_V28_LIFECYCLE_PROMOTE_DELTA_CENTS must be non-negative")
    if config.mushroom_v28_lifecycle_disable_bad_settles <= 0:
        raise ValueError("MUSHROOM_V28_LIFECYCLE_DISABLE_BAD_SETTLES must be positive")
    if config.mushroom_v28_lifecycle_min_promote_observations <= 0:
        raise ValueError("MUSHROOM_V28_LIFECYCLE_MIN_PROMOTE_OBSERVATIONS must be positive")
    ...
    if not (0.0 <= float(config.mushroom_v28_min_p_side) <= 1.0):
        raise ValueError("MUSHROOM_V28_MIN_P_SIDE must be between 0.0 and 1.0")
    ...
    if float(config.mushroom_v28_btc_ws_stale_reconnect_ms) < 0:
        raise ValueError("MUSHROOM_V28_BTC_WS_STALE_RECONNECT_MS must be non-negative")
    if float(config.mushroom_v28_btc_rest_fallback_min_interval_ms) < 0:
        raise ValueError("MUSHROOM_V28_BTC_REST_FALLBACK_MIN_INTERVAL_MS must be non-negative")
    if float(config.mushroom_v28_feature_gate_raw_edge_prob_min) < 0 and float(config.mushroom_v28_feature_gate_raw_edge_prob_min) > -1.0:
        raise ValueError("MUSHROOM_V28_FEATURE_GATE_RAW_EDGE_PROB_MIN must be non-negative, or <= -1 to disable that sub-gate")
    if float(config.mushroom_v28_feature_gate_recross_max) < 0:
        raise ValueError("MUSHROOM_V28_FEATURE_GATE_RECROSS_MAX must be non-negative")
    if float(config.mushroom_v28_feature_gate_abs_d_min) < 0:
        raise ValueError("MUSHROOM_V28_FEATURE_GATE_ABS_D_MIN must be non-negative")
    if float(config.mushroom_v28_feature_gate_abs_d_max) < 0:
        raise ValueError("MUSHROOM_V28_FEATURE_GATE_ABS_D_MAX must be non-negative")
    if (
        float(config.mushroom_v28_feature_gate_abs_d_max) > 0
        and float(config.mushroom_v28_feature_gate_abs_d_max) < float(config.mushroom_v28_feature_gate_abs_d_min)
    ):
        raise ValueError("MUSHROOM_V28_FEATURE_GATE_ABS_D_MAX must be 0 or >= MUSHROOM_V28_FEATURE_GATE_ABS_D_MIN")
    if not (0.0 <= float(config.mushroom_v28_feature_gate_ask_prob_min) <= 0.99):
        raise ValueError("MUSHROOM_V28_FEATURE_GATE_ASK_PROB_MIN must be between 0.0 and 0.99")
    if config.mushroom_v28_successor_entry_mode not in {"overlay_probability", "tested_shadow_rule"}:
        raise ValueError("MUSHROOM_V28_SUCCESSOR_ENTRY_MODE must be overlay_probability or tested_shadow_rule")
    if float(config.mushroom_v28_successor_shadow_min_edge_cents) < 0:
        raise ValueError("MUSHROOM_V28_SUCCESSOR_SHADOW_MIN_EDGE_CENTS must be non-negative")
    if config.mushroom_v28_successor_surface_enabled:
        if not str(config.mushroom_v28_successor_candidate_id or "").strip():
            raise ValueError("MUSHROOM_V28_SUCCESSOR_CANDIDATE_ID is required when successor surface is enabled")
        if not str(config.mushroom_v28_successor_model_hash or "").strip():
            raise ValueError("MUSHROOM_V28_SUCCESSOR_MODEL_HASH is required when successor surface is enabled")
        if not config.mushroom_v28_successor_manifest_path.exists():
            raise ValueError(f"MUSHROOM_V28_SUCCESSOR_MANIFEST_PATH does not exist: {config.mushroom_v28_successor_manifest_path}")
    ...
    if config.mushroom_v28_exit_guard_mode not in {"disabled", "paper", "enforce"}:
        raise ValueError("MUSHROOM_V28_EXIT_GUARD_MODE must be disabled, paper, or enforce")
    if int(config.mushroom_v28_exit_guard_max_loss_cluster) <= 0:
        raise ValueError("MUSHROOM_V28_EXIT_GUARD_MAX_LOSS_CLUSTER must be positive")
    if int(config.mushroom_v28_exit_guard_max_drawdown_cents) <= 0:
        raise ValueError("MUSHROOM_V28_EXIT_GUARD_MAX_DRAWDOWN_CENTS must be positive")
    if int(config.mushroom_v28_exit_guard_reconciliation_max_fills) <= 0:
        raise ValueError("MUSHROOM_V28_EXIT_GUARD_RECONCILIATION_MAX_FILLS must be positive")
...
def is_resting_order(order: dict[str, Any]) -> bool:
    ...
    if status in {"executed", "filled", "canceled", "cancelled", "rejected", "expired"}:
        return False
    remaining_count = parse_order_count_decimal(order, purpose="remaining")
    fill_count = parse_order_count_decimal(order, purpose="fill")
    total_count = parse_order_count_decimal(order, purpose="count")
    return remaining_count > QUANTITY_EPSILON and fill_count + QUANTITY_EPSILON < total_count
...
def live_position_ticker(position: dict[str, Any]) -> str:
    return normalize_ticker(str(position.get("ticker") or position.get("market_ticker") or ""))


def nonzero_live_positions(positions: list[dict[str, Any]] | None) -> list[dict[str, Any]]:
    out: list[dict[str, Any]] = []
    for position in positions or []:
        qty = to_decimal(position.get("position_fp", position.get("position", 0)))
        if qty is not None and qty != 0:
            out.append(position)
    return out


def live_account_position_conflict_reason(
    positions: list[dict[str, Any]] | None,
    local_position: PositionState | None,
) -> str | None:
    nonzero = nonzero_live_positions(positions)
    if not nonzero:
        return None
    if local_position is None:
        return "exchange_position_without_local_state"
    local_ticker = normalize_ticker(local_position.market_ticker)
    for position in nonzero:
        if live_position_ticker(position) != local_ticker:
            return "exchange_position_other_market"
    return None
...
def quantity_to_decimal(value: Any) -> Decimal:
...
def quantity_to_number(value: Any) -> int | float:
    qty = quantity_to_decimal(value)
...
def quantity_positive(value: Any) -> bool:
    return quantity_to_decimal(value) > QUANTITY_EPSILON


def format_quantity(value: Any) -> str:
    return format_decimal_compact(quantity_to_decimal(value))


def parse_order_count_decimal(order: dict[str, Any], *, purpose: str) -> Decimal:
    if not isinstance(order, dict):
        return Decimal("0")
    if purpose == "fill":
        keys = ("fill_count_fp", "filled_count_fp", "fill_count", "filled_count")
    elif purpose == "remaining":
        keys = ("remaining_count_fp", "remaining_count")
    else:
        keys = ("count_fp", "count")
    for key in keys:
        if key not in order:
            continue
        qty = parse_contract_quantity(order.get(key), fixed_point=key.endswith("_fp"))
        if qty is not None:
            return max(Decimal("0"), qty)
    return Decimal("0")


def normalize_cents_value_to_decimal(value: Any) -> Decimal | None:
    if value is None or isinstance(value, bool):
        return None
...
def normalize_dollars_value_to_cents_decimal(value: Any) -> Decimal | None:
    dec = to_decimal(value)
    if dec is None:
        return None
    return dec * CENTS
...
def cents_decimal_to_number(value: Decimal | None) -> int | float | None:
    if value is None:
        return None
...
def extract_order_fill_price_cents(order: dict[str, Any], *, fill_count: Any) -> int | float | None:
    fill_qty = quantity_to_decimal(fill_count)
    if fill_qty <= QUANTITY_EPSILON:
        return None
    direct_candidates = (
    ...
    for key in total_cost_candidates:
        ...
        if total_cents is None or total_cents <= 0:
            continue
        avg_cents = Decimal(str(total_cents)) / fill_qty
        if Decimal("0") < avg_cents <= Decimal("100"):
            return cents_decimal_to_number(avg_cents)
    return None


def extract_order_fee_cents(order: dict[str, Any], *, fill_count: Any) -> int | float | None:
    if quantity_to_decimal(fill_count) <= QUANTITY_EPSILON:
        return None
    direct_candidates = (
        "fee_cents",
        "fees_cents",
    ...
    for key in direct_candidates:
        ...
        if key.endswith("_cents"):
            cents = normalize_cents_value_to_decimal(raw_value)
        else:
            cents = normalize_dollars_value_to_cents_decimal(raw_value)
        if cents is not None and cents >= 0:
            return cents_decimal_to_number(cents)
    return None


def exchange_fill_matches_order(fill: dict[str, Any], *, order_id: str, client_order_id: str) -> bool:
    if not isinstance(fill, dict):
        return False
    fill_order_id = str(fill.get("order_id") or "").strip()
    if order_id and fill_order_id and fill_order_id == order_id:
        return True
    fill_client_order_id = str(fill.get("client_order_id") or fill.get("client_id") or "").strip()
    return bool(client_order_id and fill_client_order_id and fill_client_order_id == client_order_id)


def exchange_fill_price_cents(fill: dict[str, Any], side: str) -> Decimal | None:
    normalized_side = str(side or "").strip().lower()
    if normalized_side not in {"yes", "no"}:
        return None
    dollars_key = f"{normalized_side}_price_dollars"
    if fill.get(dollars_key) not in {None, ""}:
        return normalize_dollars_value_to_cents_decimal(fill.get(dollars_key))
    cents_key = f"{normalized_side}_price_cents"
    if fill.get(cents_key) not in {None, ""}:
        return normalize_cents_value_to_decimal(fill.get(cents_key))
    if fill.get(normalized_side) not in {None, ""}:
        cents = normalize_price_value_to_cents(fill.get(normalized_side))
        return Decimal(str(cents)) if cents is not None else None
    return None


def summarize_exchange_fills_for_order(
    ...
    *,
    ...
    matched = [
        fill
        for fill in fills
        if exchange_fill_matches_order(fill, order_id=order_id, client_order_id=client_order_id)
    ]
    if not matched:
        return None
    total_qty = Decimal("0")
    ...
    fill_ids: list[str] = []
    for fill in matched:
        qty = parse_contract_quantity(fill.get("count_fp"), fixed_point=True)
        if qty is None:
            qty = parse_contract_quantity(fill.get("count"), fixed_point=False)
        price_cents = exchange_fill_price_cents(fill, side)
        if qty is None or qty <= 0 or price_cents is None or price_cents <= 0:
            continue
        total_qty += qty
        total_notional_cents += qty * price_cents
        fee = normalize_dollars_value_to_cents_decimal(fill.get("fee_cost"))
        if fee is None:
            fee = normalize_cents_value_to_decimal(fill.get("fee_cents"))
    ...
    return {
        "fill_count": quantity_to_number(total_qty),
        "remaining_count": 0,
        "actual_fill_price_cents": cents_decimal_to_number(avg_price_cents),
        "actual_fee_cents": cents_decimal_to_number(total_fee_cents),
        "fill_ids": fill_ids,
    }
