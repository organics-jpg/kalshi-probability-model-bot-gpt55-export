...
& $launcher `
    ...
    -StrategyTag 'mushroom_v28_common_clock_exit_guard_v1_freshbook_size1_live' `
    -BotStorageTag 'live_mushroom_v28_common_clock_exit_guard_freshbook_size1' `
    -EntryBaseBookAgeMs '250' `
    -EntryFinalMinuteBookAgeMs '150' `
    -EntryFinalSecondsBookAgeMs '80' `
    -EntryBlockedSuppressionMs '2000' `
    -BtcWsStaleReconnectMs '0'
