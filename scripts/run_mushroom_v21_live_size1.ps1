...
$env:STRATEGY_TAG = 'mushroom_v21_physical_size1_live_test'
$env:BOT_STORAGE_TAG = 'live_mushroom_v21_physical_size1'
...
$env:DRY_RUN = 'false'
$env:LIVE_APPROVED_STRATEGY_TAG = 'mushroom_v21_physical_size1_live_test'
...
$env:MUSHROOM_V21_DECISION_ENGINE_ENABLED = 'true'
$env:MUSHROOM_V21_MIN_P_SIDE = '0.85'
$env:MUSHROOM_V21_MIN_EDGE_CENTS_15M = '2.0'
$env:MUSHROOM_V21_MAX_ASK_CENTS = '90'
$env:MUSHROOM_V21_MIN_SECONDS_TO_CLOSE = '70'
$env:MUSHROOM_V21_MAX_SECONDS_TO_CLOSE = '900'
$env:MUSHROOM_V21_MODEL_BUFFER_CENTS = '0.0'
$env:MUSHROOM_V21_SLIPPAGE_CENTS = '1.0'

$env:MUSHROOM_V28_SHADOW_ENABLED = 'false'
$env:MUSHROOM_V28_DECISION_ENGINE_ENABLED = 'false'
