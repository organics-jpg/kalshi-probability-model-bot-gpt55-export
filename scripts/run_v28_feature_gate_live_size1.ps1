...
$env:STRATEGY_TAG = 'mushroom_v28_feature_gate_raw05_recross60_abs085_ask65_size1_live'
$env:BOT_STORAGE_TAG = 'live_mushroom_v28_feature_gate_ask65_size1'
$env:TARGET_ENTRY_ODDS_CENTS = '90'
$env:POSITION_SIZE = '1'
$env:MULTI_ENTRY_SAME_MARKET_ENABLED = 'false'
$env:MULTI_ENTRY_MAX_POSITION_CONTRACTS = '1'
$env:MULTI_ENTRY_MIN_SECONDS_BETWEEN_ENTRIES = '900'
...
$env:LIVE_ENTRY_BLOCKED_SUPPRESSION_MS = '2000'
...
$env:DRY_RUN = 'false'
$env:LIVE_APPROVED_STRATEGY_TAG = 'mushroom_v28_feature_gate_raw05_recross60_abs085_ask65_size1_live'
...
$env:MUSHROOM_V28_MIN_P_SIDE = '0.01'
$env:MUSHROOM_V28_MIN_EDGE_CENTS_15M = '0.0'
$env:MUSHROOM_V28_MODEL_BUFFER_CENTS = '0.0'
$env:MUSHROOM_V28_SLIPPAGE_CENTS = '0.0'
$env:MUSHROOM_V28_MAX_ASK_CENTS = '90'
$env:MUSHROOM_V28_MIN_SECONDS_TO_CLOSE = '70'
$env:MUSHROOM_V28_MAX_SECONDS_TO_CLOSE = '900'
$env:MUSHROOM_V28_MAX_MARKET_RISK_CENTS = '100'
$env:MUSHROOM_V28_BTC_MAX_AGE_MS = '1500'
$env:MUSHROOM_V28_FEATURE_GATE_ENABLED = 'true'
$env:MUSHROOM_V28_FEATURE_GATE_RAW_EDGE_PROB_MIN = '0.05'
$env:MUSHROOM_V28_FEATURE_GATE_RECROSS_MAX = '0.60'
$env:MUSHROOM_V28_FEATURE_GATE_ABS_D_MIN = '0.85'
$env:MUSHROOM_V28_FEATURE_GATE_ASK_PROB_MIN = '0.65'
...
$env:MUSHROOM_V28_EXIT_REDUCE_P_HOLD_FLOOR = '0.0'
$env:MUSHROOM_V28_EXIT_FULL_P_HOLD_FLOOR = '0.0'
$env:MUSHROOM_V28_EXIT_FAIR_DRAWDOWN_CENTS = '4.0'
$env:MUSHROOM_V28_EXIT_FULL_DRAWDOWN_CENTS = '7.0'
