"""Frozen forward validator for raw p52 mid-edge skip.
...
from probe_v28_raw_p52_mid_edge_skip import BASE_POLICY, edge_prob, should_skip, summarize
from probe_v28_raw_physics_penalty_candidates import build_report as build_raw_report


ROOT = Path(__file__).resolve().parent
OUT_DIR = ROOT / "logs" / "edge_research"
STATE_JSON = OUT_DIR / "v28_frozen_raw_p52_mid_edge_skip_state.json"
OUT_JSON = OUT_DIR / "v28_frozen_raw_p52_mid_edge_skip_latest.json"
OUT_MD = OUT_DIR / "v28_frozen_raw_p52_mid_edge_skip_latest.md"
...
def ensure_state() -> dict[str, Any]:
    ...
    state = {
        ...
        "physics": "Middle-edge rows may be false conviction: broad enough to enter, too weak to dominate boundary/path noise.",
        "source_artifact": "v28_raw_p52_mid_edge_skip_latest.json",
    }
