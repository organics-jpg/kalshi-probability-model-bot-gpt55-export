"""Frozen forward validator for raw p52 middle-confidence early-NO boundary skip.
...
from probe_v28_raw_p52_early_no_boundary_band_skip import BASE_POLICY, is_middle_confidence_early_no_boundary
from probe_v28_raw_p52_early_no_boundary_skip import summarize
from probe_v28_raw_physics_penalty_candidates import build_report as build_raw_report


ROOT = Path(__file__).resolve().parent
OUT_DIR = ROOT / "logs" / "edge_research"
STATE_JSON = OUT_DIR / "v28_frozen_raw_p52_early_no_boundary_band_skip_state.json"
OUT_JSON = OUT_DIR / "v28_frozen_raw_p52_early_no_boundary_band_skip_latest.json"
OUT_MD = OUT_DIR / "v28_frozen_raw_p52_early_no_boundary_band_skip_latest.md"
...
def ensure_state() -> dict[str, Any]:
    ...
    state = {
        ...
        "source_artifact": "v28_raw_p52_early_no_boundary_band_skip_latest.json",
    }
