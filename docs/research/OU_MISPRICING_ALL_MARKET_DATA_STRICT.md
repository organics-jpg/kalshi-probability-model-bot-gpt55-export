...
- Generated UTC: `2026-05-14T18:04:57Z`
- Event files: `26`
- Market-results source: ``
- Snapshots after filters: `39642`
- Markets: `812`
- Trades: `552`
- Net PnL: `18.38` dollars
- Realized/settled PnL excluding open mark-to-last rows: `19.57` dollars on `537` trades
- Open mark-to-last PnL: `-1.19` dollars on `15` trades
- Win rate: `0.4656`
- Sim decisions scored: `597`

## Exit Reasons

- `last_bid_after_tape`: 15
- `max_hold`: 181
- `settlement_after_tape`: 222
- `stop_loss`: 14
- `take_profit`: 120
...
| 2026-05-05T11:24:14.740795+00:00 | KXBTC15M-26MAY050730-30 | yes | 16.0 | 70.0 | 0.51 | take_profit |
| 2026-05-05T13:20:47.675639+00:00 | KXBTC15M-26MAY050930-30 | no | 71.0 | 75.0 | 0.0 | max_hold |
