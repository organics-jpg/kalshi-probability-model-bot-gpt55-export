...
- Markets: `20`
- Trades: `14`
- Net PnL: `0.71` dollars
- Realized/settled PnL excluding open mark-to-last rows: `0.71` dollars on `14` trades
- Open mark-to-last PnL: `0.0` dollars on `0` trades
- Win rate: `0.5`
- Sim decisions scored: `22`

## Exit Reasons

- `max_hold`: 5
- `settlement_after_tape`: 6
- `take_profit`: 3

## Rejection Counts

- `edge_or_z`: 58
- `one_entry_per_market`: 400
- `sim_gate`: 8
- `spread`: 3
- `time_window`: 231
- `warming`: 119
...
| 2026-05-10T19:50:27.018399+00:00 | KXBTC15M-26MAY101600-00 | yes | 25.0 | 54.0 | 0.25 | take_profit |
| 2026-05-10T20:06:03.813106+00:00 | KXBTC15M-26MAY101615-15 | no | 40.0 | 35.0 | -0.09 | max_hold |
| 2026-05-10T20:20:42.667043+00:00 | KXBTC15M-26MAY101630-30 | yes | 36.0 | 2.0 | -0.37 | max_hold |
...
| 2026-05-10T18:21:50.890642+00:00 | KXBTC15M-26MAY101430-30 | yes | 29.0 | 0.0 | -0.31 | settlement_after_tape |
