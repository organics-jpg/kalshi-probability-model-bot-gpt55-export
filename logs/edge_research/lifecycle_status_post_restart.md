...
- Generated UTC: `2026-05-11T02:17:19.199717+00:00`
...
- Latest event: `mushroom_v28_rejected` / `book_stale` at `2026-05-11T02:17:07.081871+00:00`
...
- Reject reasons: `{'edge_below_floor': 45, 'book_stale': 50, 'feature_gate': 10, 'depth_ratio': 7, 'risk_or_depth': 2, 'btc_stale': 1, '<blank>': 51, 'single_shot_abundant_depth': 12, 'ask_too_high': 9, 'exit_trigger': 3, 'mushroom_v28_probability_collapse_full_single_shot_visible_depth': 8, 'warming': 2}`
- Lifecycle actions/buckets: `{}` / `{}`
- Lifecycle latest/reward tail: `None` / `None` / `None` / `0`c
- Exchange positions: `unavailable`
- Exchange active positions count: `0`
- Exchange resting orders: `unavailable`
- Exchange resting orders count: `None`
- Recent fills returned: `None`
- Candidate recent fills since run start: `0`
- Kalshi balance cents / portfolio cents: `None` / `None`
- Kalshi fills/fees since run: `0` / `$0.00`
- Kalshi gross/net realized since run: `$0.00` / `$0.00`
- Reconciliation snapshot appended: `False`
