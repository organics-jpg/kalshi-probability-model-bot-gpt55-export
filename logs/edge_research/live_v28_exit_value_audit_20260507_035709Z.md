...
Generated UTC: `20260507_035709Z`
...
- Actual exit net, all resolved exits: $-37.32
- Hold-to-settlement net for same entries: $-21.82
...
|---|---:|---:|---:|---:|---:|---:|
| `suppress_exit_if_btc_age_ms>=500` | False | 114 (29.01%) | $-34.04 | $16.92 | 89/25 | $-23.26/$-13.54/$2.76 |
| `suppress_exit_if_exit_bid_cents<=65` | False | 86 (21.88%) | $-40.43 | $10.53 | 44/42 | $-18.27/$-11.80/$-10.36 |
| `suppress_exit_if_btc_age_ms>=800` | False | 38 (9.67%) | $-47.54 | $3.42 | 28/10 | $-24.00/$-18.98/$-4.56 |
| `suppress_exit_if_p_hold<=0.72` | False | 92 (23.41%) | $-48.82 | $2.14 | 49/43 | $-23.96/$-15.44/$-9.42 |
| `suppress_exit_if_sigma_t_dollars>=150` | False | 14 (3.56%) | $-51.00 | $-0.04 | 10/4 | $-18.72/$-21.98/$-10.30 |
| `suppress_exit_if_sigma_t_dollars>=100` | False | 74 (18.83%) | $-51.85 | $-0.89 | 53/21 | $-20.50/$-27.66/$-3.69 |
| `suppress_exit_if_fair_drawdown_cents>=8` | False | 94 (23.92%) | $-54.05 | $-3.09 | 51/43 | $-35.03/$-9.32/$-9.70 |
| `suppress_exit_if_btc_age_ms<=100` | False | 133 (33.84%) | $-54.92 | $-3.96 | 96/37 | $-35.68/$-16.08/$-3.16 |
| `suppress_exit_if_fair_drawdown_cents<=-2` | False | 128 (32.57%) | $-63.36 | $-12.40 | 107/21 | $-28.14/$-24.26/$-10.96 |
| `suppress_exit_if_exit_bid_cents>=80` | False | 121 (30.79%) | $-66.22 | $-15.26 | 105/16 | $-32.70/$-22.62/$-10.90 |
| `suppress_exit_if_exit_bid_cents>=85` | False | 100 (25.45%) | $-67.02 | $-16.06 | 88/12 | $-31.30/$-22.62/$-13.10 |
| `suppress_exit_if_p_hold>=0.8` | False | 90 (22.90%) | $-67.46 | $-16.50 | 79/11 | $-31.22/$-23.14/$-13.10 |
| `suppress_exit_if_p_hold>=0.85` | False | 76 (19.34%) | $-69.52 | $-18.56 | 66/10 | $-32.24/$-23.14/$-14.14 |
