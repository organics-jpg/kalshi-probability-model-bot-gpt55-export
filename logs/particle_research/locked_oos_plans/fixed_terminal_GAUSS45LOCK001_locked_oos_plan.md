...
- generated_utc: 2026-05-11T17:28:18.465813+00:00
- hypothesis_id: gaussian_vol45_terminal_v1
- evaluation_scope: locked_oos_shadow
- dataset: particle_fixed_terminal_oos_GAUSS45LOCK001
- run_id: GAUSS45LOCK001
...
```powershell
python -m research_particle.paired_passive_shadow_run --dataset particle_fixed_terminal_oos_GAUSS45LOCK001 --run-id GAUSS45LOCK001 --run-seconds 3900 --checkpoint-interval-seconds 1 --checkpoint-depth 5 --status-interval-seconds 10 --record-independent-spot --independent-spot-feed coinbase --independent-spot-max-age-ms 5000 --require-independent-spot

python -m research_particle.shadow_pipeline --source-type passive_checkpoint --checkpoints "research_data\particle_fixed_terminal_oos_GAUSS45LOCK001\book_checkpoints\**\*.ndjson" --contexts "logs\particle_research\real_shadow\particle_fixed_terminal_oos_GAUSS45LOCK001\passive_contexts_independent_spot.ndjson" --root "logs\particle_research\real_shadow\particle_fixed_terminal_oos_GAUSS45LOCK001" --annualized-vol 0.65 --sample-count 2000 --seed 1 --min-fill-prob 0.5 --counterfactual-fill-threshold 0.5

python -m research_particle.kalshi_market_results --ticker <TICKER_1> --ticker <TICKER_2> --ticker <TICKER_3> --ticker <TICKER_4> --ticker <TICKER_5> --output "logs\particle_research\real_shadow\particle_fixed_terminal_oos_GAUSS45LOCK001\market_results_full_refresh.json" --issues "logs\particle_research\real_shadow\particle_fixed_terminal_oos_GAUSS45LOCK001\market_result_issues_full_refresh.json"

python -m research_particle.market_result_labels --candidates "logs\particle_research\real_shadow\particle_fixed_terminal_oos_GAUSS45LOCK001\candidate_snapshots\candidate_snapshots.ndjson" --market-results "logs\particle_research\real_shadow\particle_fixed_terminal_oos_GAUSS45LOCK001\market_results_full_refresh.json" --output "logs\particle_research\real_shadow\particle_fixed_terminal_oos_GAUSS45LOCK001\pipeline_work\label_contexts_full_refresh.ndjson"

python -m research_particle.reports --candidates "logs\particle_research\real_shadow\particle_fixed_terminal_oos_GAUSS45LOCK001\candidate_snapshots\candidate_snapshots.ndjson" --labels "logs\particle_research\real_shadow\particle_fixed_terminal_oos_GAUSS45LOCK001\pipeline_work\label_contexts_full_refresh.ndjson" --output-dir "logs\particle_research\real_shadow\particle_fixed_terminal_oos_GAUSS45LOCK001\reports" --stem passive_particle_replay_locked_oos --min-fill-prob 0.5 --counterfactual-fill-threshold 0.5

python -m research_particle.probability_variants --candidates "logs\particle_research\real_shadow\particle_fixed_terminal_oos_GAUSS45LOCK001\candidate_snapshots\candidate_snapshots.ndjson" --labels "logs\particle_research\real_shadow\particle_fixed_terminal_oos_GAUSS45LOCK001\pipeline_work\label_contexts_full_refresh.ndjson" --output-dir "logs\particle_research\real_shadow\particle_fixed_terminal_oos_GAUSS45LOCK001\reports" --stem probability_variants_locked_oos --min-fill-prob 0.5 --counterfactual-fill-threshold 0.5

python -m research_particle.fat_tail_particle_diagnostic --run-root "logs\particle_research\real_shadow\particle_fixed_terminal_oos_GAUSS45LOCK001" --output-dir "logs\particle_research\real_shadow\particle_fixed_terminal_oos_GAUSS45LOCK001\reports" --stem fat_tail_particle_locked_oos_diagnostic --min-fill-prob 0.5 --counterfactual-fill-threshold 0.5

python -m research_particle.fixed_terminal_oos --candidates "logs\particle_research\real_shadow\particle_fixed_terminal_oos_GAUSS45LOCK001\candidate_snapshots\candidate_snapshots.ndjson" --labels "logs\particle_research\real_shadow\particle_fixed_terminal_oos_GAUSS45LOCK001\pipeline_work\label_contexts_full_refresh.ndjson" --output-dir "logs\particle_research\real_shadow\particle_fixed_terminal_oos_GAUSS45LOCK001\reports" --stem fixed_terminal_oos_locked --hypothesis-id gaussian_vol45_terminal_v1 --evaluation-scope locked_oos_shadow --min-fill-prob 0.5 --counterfactual-fill-threshold 0.5 --gate-min-candidates 1000 --gate-min-markets 5 --gate-min-selected 250
```
