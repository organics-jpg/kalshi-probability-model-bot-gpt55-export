...
- baseline_models: `v28, market_side_ask, candle_brownian, blend_v28_online_lr010_w20`
...
python -m research_particle.paired_sidecar_slice_oos --plan-json "C:\Users\organ\Desktop\KALSHI PROBABILITY MODEL BOT\logs\particle_research\locked_oos_plans\paired_sidecar_slice_PSLICELOCK002_locked_plan.json" --stem paired_sidecar_slice_oos_latest --write
```
