...
- generated_utc: 2026-05-11T21:19:35.262726+00:00
- hypothesis_id: gaussian_vol45_terminal_v1
- evaluation_scope: locked_oos_shadow
- dataset: particle_fixed_terminal_oos_GAUSS45LOCK003
- run_id: GAUSS45LOCK003
- artifact_root: `logs\particle_research\real_shadow\particle_fixed_terminal_oos_GAUSS45LOCK003`
- run_seconds: 5400
...
python -m research_particle.fat_tail_particle_diagnostic --run-root "logs\particle_research\real_shadow\particle_fixed_terminal_oos_GAUSS45LOCK003" --output-dir "logs\particle_research\real_shadow\particle_fixed_terminal_oos_GAUSS45LOCK003\reports" --stem fat_tail_particle_locked_oos_diagnostic --min-fill-prob 0.5 --counterfactual-fill-threshold 0.5

python -m research_particle.fixed_terminal_oos --candidates "logs\particle_research\real_shadow\particle_fixed_terminal_oos_GAUSS45LOCK003\candidate_snapshots\candidate_snapshots.ndjson" --labels "logs\particle_research\real_shadow\particle_fixed_terminal_oos_GAUSS45LOCK003\pipeline_work\label_contexts_full_refresh.ndjson" --output-dir "logs\particle_research\real_shadow\particle_fixed_terminal_oos_GAUSS45LOCK003\reports" --stem fixed_terminal_oos_locked --hypothesis-id gaussian_vol45_terminal_v1 --evaluation-scope locked_oos_shadow --min-fill-prob 0.5 --counterfactual-fill-threshold 0.5 --gate-min-candidates 1000 --gate-min-markets 5 --gate-min-selected 250
```
