"""Frozen forward challenger for low-recross coverage repair.
...
Frozen rule:
    ...
    floor using clean repair rows ranked by lowest recross hazard, preferring
    otherwise missed markets first.
"""
...
STATE_JSON = OUT_DIR / "v28_frozen_low_recross_repair_entry_state.json"
OUT_JSON = OUT_DIR / "v28_frozen_low_recross_repair_entry_latest.json"
OUT_MD = OUT_DIR / "v28_frozen_low_recross_repair_entry_latest.md"
...
def load_or_create_state() -> dict[str, Any]:
    ...
    state = {
        ...
        "physics": "Toxic rows are boundary/paid-price instability; repairs should come from calmer low-recross states rather than same-market churn.",
    }
