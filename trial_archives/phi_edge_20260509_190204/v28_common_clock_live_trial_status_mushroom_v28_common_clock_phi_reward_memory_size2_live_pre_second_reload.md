...
- Generated UTC: `2026-05-09T20:18:53.340086+00:00`
...
- Latest event: `mushroom_v28_rejected` / `feature_gate` at `2026-05-09T20:18:50.024538+00:00`
...
- Reject reasons: `{'edge_below_floor': 32, 'book_stale': 42, 'ask_too_high': 11, 'feature_gate': 6, '<blank>': 10, 'single_shot_abundant_depth': 20, 'depth_ratio': 3, 'exit_trigger': 18, 'mushroom_v28_exit_value_over_hold_single_shot_visible_depth': 36, 'mushroom_v28_probability_collapse_full_single_shot_visible_depth': 8, 'warming': 2, 'time_window': 8, 'missing_horizon': 4}`
- Exchange positions: `[]`
