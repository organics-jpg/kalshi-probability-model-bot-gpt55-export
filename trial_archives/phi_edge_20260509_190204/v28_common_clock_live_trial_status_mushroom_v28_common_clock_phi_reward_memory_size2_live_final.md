...
- Generated UTC: `2026-05-09T20:21:45.590236+00:00`
...
- Latest event: `mushroom_v28_rejected` / `book_stale` at `2026-05-09T20:21:36.856463+00:00`
- Event counts: `{'order_submit_start': 11, 'order_submit_success': 11, 'execution_deferred': 1, 'mushroom_v28_rejected': 111, 'mushroom_v28_approved': 4, 'signal_seen': 4, 'plan_built': 4, 'fill_full': 6, 'exit_signal_seen': 6, 'exit_snapshot_built': 6, 'exit_capacity_estimated': 6, 'exit_plan_built': 6, 'exit_submit_start': 6, 'exit_submit_zero_fill': 4, 'exit_execution_deferred': 8, 'exit_submit_full': 2, 'exit_submit_success': 2, 'exit_reconciled': 2}`
- Reject reasons: `{'single_shot_abundant_depth': 19, 'depth_ratio': 6, '<blank>': 8, 'exit_trigger': 18, 'mushroom_v28_exit_value_over_hold_single_shot_visible_depth': 36, 'edge_below_floor': 34, 'ask_too_high': 5, 'book_stale': 40, 'mushroom_v28_probability_collapse_full_single_shot_visible_depth': 8, 'warming': 4, 'time_window': 8, 'missing_horizon': 4, 'feature_gate': 8, 'btc_stale': 2}`
- Exchange positions: `[]`
