...
$env:STRATEGY_TAG = 'entry_87_ladder_hold'
$env:BOT_STORAGE_TAG = 'live_87_77_67'
...
$env:LADDER_LEVELS = '87,77,67'
$env:LADDER_SIZES = '10,10,10'
$env:LADDER_ALLOWED_SESSIONS = 'overnight,morning'
...
$env:DRY_RUN = 'false'
$env:LIVE_APPROVED_STRATEGY_TAG = 'entry_87_ladder_hold'
