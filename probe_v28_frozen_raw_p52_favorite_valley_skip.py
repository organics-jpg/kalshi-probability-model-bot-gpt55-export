"""Frozen forward validator for raw p52 favorite-valley skip.
...
from probe_v28_raw_p52_favorite_valley_skip import BASE_POLICY, ask_prob, is_favorite_valley, summarize
from probe_v28_raw_physics_penalty_candidates import build_report as build_raw_report


ROOT = Path(__file__).resolve().parent
OUT_DIR = ROOT / "logs" / "edge_research"
STATE_JSON = OUT_DIR / "v28_frozen_raw_p52_favorite_valley_skip_state.json"
OUT_JSON = OUT_DIR / "v28_frozen_raw_p52_favorite_valley_skip_latest.json"
OUT_MD = OUT_DIR / "v28_frozen_raw_p52_favorite_valley_skip_latest.md"
...
def ensure_state() -> dict[str, Any]:
    ...
    state = {
        ...
        "physics": "Middle-favorite prices have large loss severity without enough certainty; keep only if future evidence proves the skipped band is negative EV.",
        "source_artifact": "v28_raw_p52_favorite_valley_skip_latest.json",
    }
...
def write_md(report: dict[str, Any]) -> None:
    ...
    lines.extend(["", "## Skipped Future Rows", "", "| market | side | source | p | ask | won | net c |", "|---|---|---|---:|---:|---|---:|"])
