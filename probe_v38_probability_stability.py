"""Block-stability audit for the v38 FV probability surface.

This is a pure probability audit, not a scorer or execution backtest. It
compares v38 with v34 and v37 across chronological market blocks in both replay
denominators.
...
REPORT_MD = OUT_DIR / "v38_probability_stability_latest.md"
REPORT_JSON = OUT_DIR / "v38_probability_stability_latest.json"
SUMMARY_CSV = OUT_DIR / "v38_probability_stability_summary_latest.csv"
BLOCK_CSV = OUT_DIR / "v38_probability_stability_blocks_latest.csv"
...
CANDIDATE = "v38_long60_antipersist"
BASES = ["v34_material_antipersist3", "v37_piecewise_dynamic_temp_antipersist3"]
...
def main() -> int:
    ...
    print("v38 probability stability complete")
